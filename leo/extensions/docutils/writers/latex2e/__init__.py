...
class Babel(object):
    ...
    def __init__(self, language_code, reporter=None):
        ...
        if self.language in ('ngerman', 'german', 'austrian', 'naustrian',
            ...
            self.literal_double_quote = u'\\dq{}' ### ur'\dq{}'
        if self.language == 'french':
            self.quotes = (r'\og{}', r'\fg{}')
        if self.language == 'italian':
            self.literal_double_quote = u'{\\char`\\"}' ###  ur'{\char`\"}'
...
class CharMaps(object):
    ...
    special = {
        ...
        ord('%'): u'\\%',  ### ur'%',
        ord('&'): u'\\&',  ### ur'&',
        ord('~'): u'\\textasciitilde{}',  ### ur'textasciitilde{}',
        ord('_'): u'\\_',  ### ur'_',
        ord('^'): u'\\textasciicircum{}', ### ur'textasciicircum{}',
        ord('\\'): u'\\textbackslash{}',  ### ur'textbackslash{}',
        ord('{'): u'\\{',  ### ur'{',
        ord('}'): u'\\}',  ### ur'}',
        ...
        0x00AD: u'\\-',  ### ur'-', # SOFT HYPHEN
    }
    # Unicode chars that are not recognized by LaTeX's utf8 encoding
    unsupported_unicode = {
        0x00A0: u'~',                   ### ur'~', # NO-BREAK SPACE
        # TODO: ensure white space also at the beginning of a line?
        # 0x00A0: ur'\leavevmode\nobreak\vadjust{}~'
        0x2008: u'\\,',                 ### ur',',       # PUNCTUATION SPACE   
        0x2011: u'\\hbox{-}',           ### ur'hbox{-}', # NON-BREAKING HYPHEN
        0x202F: u'\\,',                 ### ur',',       # NARROW NO-BREAK SPACE
        0x21d4: u'$\\Leftrightarrow$',  ### ur'$\Leftrightarrow$',
        # Docutils footnote symbols:
        0x2660: u'$\\spadesuit$',       ### ur'$\spadesuit$',
        0x2663: u'$\\clubsuit$',        ### ur'$\clubsuit$',
    }
    # Unicode chars that are recognized by LaTeX's utf8 encoding
    utf8_supported_unicode = {
        0x00AB: u'\\guillemotleft',  ### ur'guillemotleft',  # LEFT-POINTING DOUBLE ANGLE QUOTATION MARK
        0x00bb: u'\\guillemotright', ### ur'guillemotright', # RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
        0x200C: u'\\textcompwordmark',      ### ur'textcompwordmark', # ZERO WIDTH NON-JOINER
        0x2013: u'\\textendash{}',          ### ur'textendash{}',
        0x2014: u'\\textemdash{}',          ### ur'textemdash{}',
        0x2018: u'\\textquoteleft{}',       ### ur'textquoteleft{}',
        0x2019: u'\\textquoteright{}',      ### ur'textquoteright{}',
        0x201A: u'\\quotesinglbase{}',      ### ur'quotesinglbase{}', # SINGLE LOW-9 QUOTATION MARK
        0x201C: u'\\textquotedblleft{}',    ### ur'textquotedblleft{}',
        0x201D: u'\\textquotedblright{}',   ### ur'textquotedblright{}',
        0x201E: u'\\quotedblbase{}',        ### ur'quotedblbase{}',     # DOUBLE LOW-9 QUOTATION MARK
        0x2030: u'\\textperthousand{}',     ### ur'textperthousand{}',   # PER MILLE SIGN
        0x2031: u'\\textpertenthousand{}',  ### ur'textpertenthousand{}', # PER TEN THOUSAND SIGN
        0x2039: u'\\guilsinglleft{}',       ### ur'guilsinglleft{}',
        0x203A: u'\\guilsinglright{}',      ### ur'guilsinglright{}',
        0x2423: u'\\textvisiblespace{}',    ### ur'textvisiblespace{}',  # OPEN BOX
        0x2020: u'\\dag{}',     ### ur'dag{}',
        0x2021: u'\\ddag{}',    ### ur'ddag{}',
        0x2026: u'\\dots{}',    ### ur'dots{}',
        0x2122: u'\\texttrademark{}',  ### ur'texttrademark{}',
    }
    # recognized with 'utf8', if textcomp is loaded
    textcomp = {
        # Latin-1 Supplement
        0x00a2: u'\\textcent{}',            ### ur'textcent{}',         # ¢ CENT SIGN
        0x00a4: u'\\textcurrency{}',        ### ur'textcurrency{}',     # ¤ CURRENCY SYMBOL
        0x00a5: u'\\textyen{}',             ### ur'textyen{}',          # ¥ YEN SIGN
        0x00a6: u'\\textbrokenbar{}',       ### ur'textbrokenbar{}',    # ¦ BROKEN BAR
        0x00a7: u'\\textsection{}',         ### ur'textsection{}',      # § SECTION SIGN
        0x00a8: u'\\textasciidieresis{}',   ### ur'textasciidieresis{}',# ¨ DIAERESIS
        0x00a9: u'\\textcopyright{}',       ### ur'textcopyright{}',    # © COPYRIGHT SIGN
        0x00aa: u'\\textordfeminine{}',     ### ur'textordfeminine{}',  # ª FEMININE ORDINAL INDICATOR
        0x00ac: u'\\textlnot{}',            ### ur'textlnot{}',         # ¬ NOT SIGN
        0x00ae: u'\\textregistered{}',      ### ur'textregistered{}',   # ® REGISTERED SIGN
        0x00af: u'\\textasciimacron{}',     ### ur'textasciimacron{}',  # ¯ MACRON
        0x00b0: u'\\textdegree{}',          ### ur'textdegree{}',       # ° DEGREE SIGN
        0x00b1: u'\\textpm{}',              ### ur'textpm{}',           # ± PLUS-MINUS SIGN
        0x00b2: u'\\texttwosuperior{}',     ### ur'texttwosuperior{}',  # ² SUPERSCRIPT TWO
        0x00b3: u'\\textthreesuperior{}',   ### ur'textthreesuperior{}',# ³ SUPERSCRIPT THREE
        0x00b4: u'\\textasciiacute{}',      ### ur'textasciiacute{}',   # ´ ACUTE ACCENT
        0x00b5: u'\\textmu{}',              ### ur'textmu{}',           # µ MICRO SIGN
        0x00b6: u'\\textparagraph{}',       ### ur'textparagraph{}',    # ¶ PILCROW SIGN # not equal to \textpilcrow
        0x00b9: u'\\textonesuperior{}',     ### ur'textonesuperior{}',   # ¹ SUPERSCRIPT ONE
        0x00ba: u'\\textordmasculine{}',    ### ur'textordmasculine{}',  # º MASCULINE ORDINAL INDICATOR
        0x00bc: u'\\textonequarter{}',      ### ur'textonequarter{}',    # 1/4 FRACTION
        0x00bd: u'\\textonehalf{}',         ### ur'textonehalf{}',       # 1/2 FRACTION
        0x00be: u'\\textthreequarters{}',   ### ur'textthreequarters{}', # 3/4 FRACTION
        0x00d7: u'\\texttimes{}',           ### ur'texttimes{}',         # × MULTIPLICATION SIGN
        0x00f7: u'\\textdiv{}',             ### ur'textdiv{}',           # ÷ DIVISION SIGN
        #
        0x0192: u'\\textflorin{}',          ### ur'textflorin{}',        # LATIN SMALL LETTER F WITH HOOK
        0x02b9: u'\\textasciiacute{}',      ### ur'textasciiacute{}',    # MODIFIER LETTER PRIME
        0x02ba: u'\\textacutedbl{}',        ### ur'textacutedbl{}',      # MODIFIER LETTER DOUBLE PRIME
        0x2016: u'\\textbardbl{}',          ### ur'textbardbl{}',        # DOUBLE VERTICAL LINE
        0x2022: u'\\textbullet{}',          ### ur'textbullet{}',        # BULLET
        0x2032: u'\\textasciiacute{}',      ### ur'textasciiacute{}',    # PRIME
        0x2033: u'\\textacutedbl{}',        ### ur'textacutedbl{}',      # DOUBLE PRIME
        0x2035: u'\\textasciigrave{}',      ### ur'textasciigrave{}',    # REVERSED PRIME
        0x2036: u'\\textgravedbl{}',        ### ur'textgravedbl{}',      # REVERSED DOUBLE PRIME
        0x203b: u'\\textreferencemark{}',   ### ur'textreferencemark{}', # REFERENCE MARK
        0x203d: u'\\textinterrobang{}',     ### ur'textinterrobang{}',   # INTERROBANG
        0x2044: u'\\textfractionsolidus{}', ### ur'textfractionsolidus{}', # FRACTION SLASH
        0x2045: u'\\textlquill{}',          ### ur'textlquill{}',        # LEFT SQUARE BRACKET WITH QUILL
        0x2046: u'\\textrquill{}',          ### ur'textrquill{}',        # RIGHT SQUARE BRACKET WITH QUILL
        0x2052: u'\\textdiscount{}',        ### ur'textdiscount{}',      # COMMERCIAL MINUS SIGN
        0x20a1: u'\\textcolonmonetary{}',   ### ur'textcolonmonetary{}', # COLON SIGN
        0x20a3: u'\\textfrenchfranc{}',     ### ur'textfrenchfranc{}',   # FRENCH FRANC SIGN
        0x20a4: u'\\textlira{}',            ### ur'textlira{}',          # LIRA SIGN
        0x20a6: u'\\textnaira{}',           ### ur'textnaira{}',         # NAIRA SIGN
        0x20a9: u'\\textwon{}',             ### ur'textwon{}',           # WON SIGN
        0x20ab: u'\\textdong{}',            ### ur'textdong{}',          # DONG SIGN
        0x20ac: u'\\texteuro{}',            ### ur'texteuro{}',          # EURO SIGN
        0x20b1: u'\\textpeso{}',            ### ur'textpeso{}',          # PESO SIGN
        0x20b2: u'\\textguarani{}',         ### ur'textguarani{}',       # GUARANI SIGN
        0x2103: u'\\textcelsius{}',         ### ur'textcelsius{}',       # DEGREE CELSIUS
        0x2116: u'\\textnumero{}',          ### ur'textnumero{}',        # NUMERO SIGN
        0x2117: u'\\textcircledP{}',        ### ur'textcircledP{}',      # SOUND RECORDING COYRIGHT
        0x211e: u'\\textrecipe{}',          ### ur'textrecipe{}',        # PRESCRIPTION TAKE
        0x2120: u'\\textservicemark{}',     ### ur'textservicemark{}',   # SERVICE MARK
        0x2122: u'\\texttrademark{}',       ### ur'texttrademark{}',     # TRADE MARK SIGN
        0x2126: u'\\textohm{}',             ### ur'textohm{}',           # OHM SIGN
        0x2127: u'\\textmho{}',             ### ur'textmho{}',           # INVERTED OHM SIGN
        0x212e: u'\\textestimated{}',       ### ur'textestimated{}',     # ESTIMATED SYMBOL
        0x2190: u'\\textleftarrow{}',       ### ur'textleftarrow{}',     # LEFTWARDS ARROW
        0x2191: u'\\textuparrow{}',         ### ur'textuparrow{}',       # UPWARDS ARROW
        0x2192: u'\\textrightarrow{}',      ### ur'textrightarrow{}',    # RIGHTWARDS ARROW
        0x2193: u'\\textdownarrow{}',       ### ur'textdownarrow{}',     # DOWNWARDS ARROW
        0x2212: u'\\textminus{}',           ### ur'textminus{}',         # MINUS SIGN
        0x2217: u'\\textasteriskcentered{}',  ### ur'textasteriskcentered{}', # ASTERISK OPERATOR
        0x221a: u'\\textsurd{}',            ### ur'textsurd{}',          # SQUARE ROOT
        0x2422: u'\\textblank{}',           ### ur'textblank{}',         # BLANK SYMBOL
        0x25e6: u'\\textopenbullet{}',      ### ur'textopenbullet{}',    # WHITE BULLET
        0x25ef: u'\\textbigcircle{}',       ### ur'textbigcircle{}',     # LARGE CIRCLE
        0x266a: u'\\textmusicalnote{}',     ### ur'textmusicalnote{}',   # EIGHTH NOTE
        0x26ad: u'\\textmarried{}',         ### ur'textmarried{}',       # MARRIAGE SYMBOL
        0x26ae: u'\\textdivorced{}',        ### ur'textdivorced{}',      # DIVORCE SYMBOL
        0x27e8: u'\\textlangle{}',          ### ur'textlangle{}',        # MATHEMATICAL LEFT ANGLE BRACKET
        0x27e9: u'\\textrangle{}',          ### ur'textrangle{}',        # MATHEMATICAL RIGHT ANGLE BRACKET
    }
    # Unicode chars that require a feature/package to render
    pifont = {
        0x2665: u'\\ding{170}',     ### ur'ding{170}',     # black heartsuit
        0x2666: u'\\ding{169}',     ### ur'ding{169}',     # black diamondsuit
        0x2713: u'\\ding{51}',      ### ur'ding{51}',      # check mark
        0x2717: u'\\ding{55}',      ### ur'ding{55}',      # check mark
    }
    # TODO: greek alphabet ... ?
        ...
        * Separate ``-`` (and more in literal text) to prevent input ligatures.
        ...
        if self.font_encoding in ['OT1', ''] and not self.is_xetex:
            ...
            if self.literal:
                ...
                table[ord('\\')] = u'\\reflectbox{/}' ### ur'\reflectbox{/}'
            # * ``< | >`` come out as different chars (except for cmtt):
            else:
                table[ord('|')] = u'\\textbar{}'     ### ur'\textbar{}'
                table[ord('<')] = u'\\textless{}'    ### ur'\textless{}'
                table[ord('>')] = u'\\textgreater{}' ### ur'\textgreater{}'
