...
class DebugCommandsClass(BaseEditCommandsClass):
    ...
    @cmd('debug')
    def invoke_debugger(self, event: LeoKeyEvent) -> None:
        """
    ...
    @cmd('dump-node')
    def dumpNode(self, event: LeoKeyEvent) -> None:
    ...
    def collectGarbage(self, event: LeoKeyEvent) -> None:
    ...
    def killLogListener(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('show-focus')
    def printFocus(self, event: LeoKeyEvent) -> None:
        """
