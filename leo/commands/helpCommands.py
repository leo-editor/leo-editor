...
class HelpCommandsClass(BaseEditCommandsClass):
    ...
    @cmd('help')
    def help_command(self, event: LeoKeyEvent) -> None:
    ...
    def helpForAbbreviations(self, event: LeoKeyEvent) -> None:
    ...
    def helpForAutocompletion(self, event: LeoKeyEvent) -> None:
    ...
    def helpForBindings(self, event: LeoKeyEvent) -> None:
    ...
    def helpForCreatingExternalFiles(self, event: LeoKeyEvent) -> None:
    ...
    def helpForDebuggingCommands(self, event: LeoKeyEvent) -> None:
    ...
    def helpForDragAndDrop(self, event: LeoKeyEvent) -> None:
    ...
    def helpForDynamicAbbreviations(self, event: LeoKeyEvent) -> None:
        """Explains Leo's abbreviations."""
        # @+<< define s >>
    ...
    def helpForFindCommands(self, event: LeoKeyEvent) -> None:
    ...
    def helpForLayouts(self, event: LeoKeyEvent) -> None:
    ...
    def helpForRegularExpressions(self, event: LeoKeyEvent) -> None:
    ...
    def helpForScripting(self, event: LeoKeyEvent) -> None:
    ...
    def helpForSettings(self, event: LeoKeyEvent) -> None:
    ...
    def showColorSettings(self, event: LeoKeyEvent) -> None:
        """
    ...
    def showFontSettings(self, event: LeoKeyEvent) -> None:
        """
    ...
    @cmd('show-settings')
    def showSettings(self, event: LeoKeyEvent) -> None:
        """
    ...
    def showSettingsOutline(self, event: LeoKeyEvent) -> None:
        """
    ...
    @cmd('help-for-python')
    def pythonHelp(self, event: LeoKeyEvent) -> None:
