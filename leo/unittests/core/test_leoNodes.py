...
class NodesTest(unittest.TestCase):
    ...
    def test_all_nodes_coverage(self):
        ...
        for v in v1:
            self.assertTrue(v in v2)
    #@+node:ekr.20210830095545.3: *3* TestNode.test_all_generators_return_unique_positions
    def test_all_generators_return_unique_positions(self):
        ...
        for kind, generator in table:
            ...
            for p in generator():
                if p in aList:
                    print('FAIL: %s %s %s' % (kind, p.gnx, p.h))
                    fail.append(kind)
                else:
                    aList.append(p)
            if len(aList) < 1:
                print('FAIL: %s len %s' % (kind, len(aList)))
                fail.append(kind)
        assert not fail, fail
    #@+node:ekr.20210830095545.41: *3* TestNode.test_at_most_one_VNode_has_str_leo_pos_attribute
        ...
        for v in c.all_unique_vnodes_iter():
            if hasattr(v,'unknownAttributes'):
                ...
                if d.get('str_leo_pos'):
                    n += 1
        assert n < 2
    #@+node:ekr.20210830095545.58: *3* TestNode.test_at_others_directive
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now()
    #@+node:ekr.20210830095545.6: *3* TestNode.test_c_positionExists
    ...
    #@+node:ekr.20210830095545.7: *3* TestNode.test_c_positionExists_for_all_nodes
    ...
    #@+node:ekr.20210830095545.8: *3* TestNode.test_c_safe_all_positions
    def test_c_safe_all_positions(self):
        ...
        assert n1 == n2,(n1,n2)
    #@+node:ekr.20210830095545.9: *3* TestNode.test_check_all_gnx_s_exist_and_are_unique
    ...
    #@+node:ekr.20210830095545.42: *3* TestNode.test_clone_and_move_the_clone_to_the_root
        ...
        try:
            ...
            if 1:
                while p.hasChildren():
                    p.firstChild().doDelete(newNode=None)
            c.redraw_now(p)
    #@+node:ekr.20210830095545.2: *3* TestNode.test_consistency_between_parents_iter_and_v_parents
    def test_consistency_between_parents_iter_and_v_parents(self):
        ...
        try:
            ...
            raise
    #@+node:ekr.20210830095545.10: *3* TestNode.test_consistency_of_back_next_links
    ...
    #@+node:ekr.20210830095545.11: *3* TestNode.test_consistency_of_c_all_positions__and_p_ThreadNext_
    ...
    #@+node:ekr.20210830095545.12: *3* TestNode.test_consistency_of_firstChild__children_iter_
    def test_consistency_of_firstChild__children_iter_(self):
        ...
        assert not p2, repr(p2)
    #@+node:ekr.20210830095545.13: *3* TestNode.test_consistency_of_level
    ...
    #@+node:ekr.20210830095545.14: *3* TestNode.test_consistency_of_parent__parents_iter_
    def test_consistency_of_parent__parents_iter_(self):
        ...
        for p in c.all_positions():
            ...
            assert not p2, repr(p2)
    #@+node:ekr.20210830095545.15: *3* TestNode.test_consistency_of_parent_child_links
    ...
    #@+node:ekr.20210830095545.16: *3* TestNode.test_consistency_of_threadBack_Next_links
    ...
    #@+node:ekr.20210830095545.17: *3* TestNode.test_convertTreeToString_and_allies
    def test_convertTreeToString_and_allies(self):
        p = self.c.p
        p = p.firstChild()
        assert(p.h=="File Conversion")
        p.convertTreeToString()
    #@+node:ekr.20210830095545.43: *3* TestNode.test_delete_node
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now(root)
    #@+node:ekr.20210830095545.44: *3* TestNode.test_deleting_the_root_should_select_another_node
    def test_deleting_the_root_should_select_another_node(self):
        ...
        if g.app.isExternalUnitTest:
            ...
            try:
                ...
                # c.selectPosition(p)
                c.redraw_now()
    #@+node:ekr.20210830095545.45: *3* TestNode.test_demote
        ...
        try:
            ...
            if 0:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now(root)
    #@+node:ekr.20210830095545.18: *3* TestNode.test_leoNodes_properties
    ...
    #@+node:ekr.20210830095545.47: *3* TestNode.test_move_outline_down__undo_redo
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now(root)
    #@+node:ekr.20210830095545.48: *3* TestNode.test_move_outline_left
        ...
        try:
            ...
            if 1:
                while p.hasChildren():
                    p.firstChild().doDelete(newNode=None)
                c.redraw_now(p)
    #@+node:ekr.20210830095545.49: *3* TestNode.test_move_outline_right
    def test_move_outline_right(self):
        ...
        try:
            ...
            if 1:
                c.redraw_now(p)
    #@+node:ekr.20210830095545.50: *3* TestNode.test_move_outline_up
    def test_move_outline_up(self):
        ...
        try:
            ...
            if 1:
                c.redraw_now(p)
    #@+node:ekr.20210830095545.19: *3* TestNode.test_new_vnodes_methods
    def test_new_vnodes_methods(self):
        ...
        p.expand()
        c.redraw()
    #@+node:ekr.20210830095545.20: *3* TestNode.test_newlines_in_headlines
    def test_newlines_in_headlines(self):
        ...
        try:
            ...
            p.h = h
    #@+node:ekr.20210830095545.54: *3* TestNode.test_node_that_doesn_t_belong_to_a_derived_file
    def test_node_that_doesn_t_belong_to_a_derived_file(self):
        ...
        try:
            ...
            if parent:
                parent.h = parent.h[1:]
            c.redraw_now()
    #@+node:ekr.20210830095545.56: *3* TestNode.test_organizer_node
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now()
    #@+node:ekr.20210830095545.21: *3* TestNode.test_p__eq_
    ...
    #@+node:ekr.20210830095545.23: *3* TestNode.test_p_adjustPositionBeforeUnlink
    def test_p_adjustPositionBeforeUnlink(self):
        ...
        #@+others
        #@-others
    #@+node:ekr.20210830095545.24: *3* TestNode.test_p_comparisons
    ...
    #@+node:ekr.20210830095545.25: *3* TestNode.test_p_deletePositionsInList
    def test_p_deletePositionsInList(self):
        ...
        c.redraw()
    #@+node:ekr.20210830095545.26: *3* TestNode.test_p_hasNextBack
    ...
    #@+node:ekr.20210830095545.27: *3* TestNode.test_p_hasParentChild
    ...
    #@+node:ekr.20210830095545.28: *3* TestNode.test_p_hasThreadNextBack
    ...
    #@+node:ekr.20210830095545.29: *3* TestNode.test_p_isAncestorOf
    ...
    #@+node:ekr.20210830095545.30: *3* TestNode.test_p_isCurrentPosition
    ...
    #@+node:ekr.20210830095545.31: *3* TestNode.test_p_isRootPosition
    def test_p_isRootPosition(self):
        c, p = self.c, self.c.p
        assert not c.isRootPosition(None),'fail 1'
        assert not c.isRootPosition(p),'fail 2'
    #@+node:ekr.20210830095545.33: *3* TestNode.test_p_moveToFirst_LastChild
    def test_p_moveToFirst_LastChild(self):
        ...
        try:
            ...
            if 1:
                setup(child)
            c.redraw(p)
    #@+node:ekr.20210830095545.34: *3* TestNode.test_p_moveToVisBack_in_a_chapter
    ...
    #@+node:ekr.20210830095545.35: *3* TestNode.test_p_nosentinels
    ...
    #@+node:ekr.20210830095545.22: *3* TestNode.test_p_relinkAsCloneOf
    def test_p_relinkAsCloneOf(self):
        ...
        assert p1 and p2
        u.clearUndoState()
    #@+node:ekr.20210830095545.36: *3* TestNode.test_p_setBodyString
    def test_p_setBodyString(self):
        ...
        try:
            ...
            c.selectPosition(p)
    #@+node:ekr.20210830095545.37: *3* TestNode.test_p_u
    def test_p_u(self):
        p = self.c.p
    ...
    #@+node:ekr.20210830095545.38: *3* TestNode.test_p_unique_nodes
    ...
    #@+node:ekr.20210830095545.51: *3* TestNode.test_paste_node
    def test_paste_node(self):
        ...
        try:
            ...
            if 1:
                c.redraw_now(p)
    #@+node:ekr.20210830095545.52: *3* TestNode.test_paste_retaining_clones
    def test_paste_retaining_clones(self):
        ...
        try:
            ...
            if 1:
                c.redraw_now(p)
    #@+node:ekr.20210830095545.4: *3* TestNode.test_position_not_hashable
    def test_position_not_hashable(self):
        ...
        try:
            ...
            pass
    #@+node:ekr.20210830095545.53: *3* TestNode.test_promote
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now(root)
    #@+node:ekr.20210830095545.55: *3* TestNode.test_root_of_a_derived_file
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now()
    #@+node:ekr.20210830095545.57: *3* TestNode.test_section_node
        ...
        try:
            ...
            if 1:
                while root.hasChildren():
                    root.firstChild().doDelete(newNode=None)
            c.redraw_now()
    #@+node:ekr.20210830095545.39: *3* TestNode.test_v_atAutoNodeName__v_atAutoRstNodeName
    ...
    #@+node:ekr.20210830095545.40: *3* TestNode.test_zz_end_of_leoNodes_tests
    def test_zz_end_of_leoNodes_tests(self):
