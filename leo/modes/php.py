...
# Rules for the php_tags ruleset...
...
def php_php_rule1(colorer, s, i):
    return colorer.match_span(s, i, kind="comment3", begin="/**", end="*/",
        at_line_start=False, at_whitespace_end=False, at_word_start=False,
        delegate="php::phpdoc",exclude_match=False,
        no_escape=False, no_line_break=False, no_word_break=False)

def php_php_rule2(colorer, s, i):
    return colorer.match_span(s, i, kind="comment1", begin="/*", end="*/",
        at_line_start=False, at_whitespace_end=False, at_word_start=False,
        delegate="",exclude_match=False,
        no_escape=False, no_line_break=False, no_word_break=False)
...
def php_php_rule6(colorer, s, i):
    return colorer.match_eol_span(s, i, kind="comment2", seq="//",
        at_line_start=False, at_whitespace_end=False, at_word_start=False,
        delegate="", exclude_match=False)

def php_php_rule7(colorer, s, i):
...
def php_php_rule31(colorer, s, i):
    return colorer.match_seq(s, i, kind="operator", seq=">=",
        at_line_start=False, at_whitespace_end=False, at_word_start=False, delegate="")

def php_php_rule32(colorer, s, i):
    return colorer.match_seq(s, i, kind="operator", seq="<=",
        at_line_start=False, at_whitespace_end=False, at_word_start=False, delegate="")

def php_php_rule33(colorer, s, i):
    return colorer.match_seq(s, i, kind="operator", seq="=",
        at_line_start=False, at_whitespace_end=False, at_word_start=False, delegate="")
...
php_php_rulesdict = {
    ...
    ".": [php_php_rule45,],
    "/": [php_php_rule1,php_php_rule2,php_php_rule6,php_php_rule36,],
    "0": [php_php_rule56,],
    "1": [php_php_rule56,],
    "2": [php_php_rule56,],
    "3": [php_php_rule56,],
    ...
    ":": [php_php_rule54,],
    ";": [php_php_rule49,],
    "<": [php_php_rule32,php_php_rule39,],
    "< ": [php_php_rule8,],
    "=": [php_php_rule10,php_php_rule33,],
    ">": [php_php_rule31,php_php_rule38,],
    "?": [php_php_rule52,],
...
# Rules for the php_javascript ruleset...
...
if use_php_hack:
    ...
    rulesDictDict['php_main'] = php_php_rulesdict # EKR: was php_rulesDict1
