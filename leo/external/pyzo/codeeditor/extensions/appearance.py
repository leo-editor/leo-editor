...
import enum
class HighlightMatchingOccurrences(object): # tag:CodeEditor
...
class HighlightMatchingBracket(object): # tag:CodeEditor
    ...
    def setHighlightMisMatchingBracket(self,value):
        ...
        self.viewport().update()
class HighlightCurrentLine(object): # tag:CodeEditor
    """
...
class IndentationGuides(object): # tag:CodeEditor
    ...
    def paintEvent(self,event):
        ...
        # Done
        painter.end()
class FullUnderlines(object): # tag:CodeEditor
    ...
    def paintEvent(self,event):
        ...
        painter.end()
class CodeFolding(object): # tag:CodeEditor
    def paintEvent(self,event):
        """ paintEvent(event)
        ...
        painter.end()
class LongLineIndicator(object): # tag:CodeEditor
    ...
    def paintEvent(self, event):
        ...
        # Propagate event
        super(LongLineIndicator, self).paintEvent(event)
class ShowWhitespace(object): # tag:CodeEditor
...
class ShowLineEndings(object): # tag:CodeEditor
    ...
    def setShowLineEndings(self,value):
        ...
        if value:
            ...
            option.setFlags(option.flags() & ~option.ShowLineAndParagraphSeparators)
        self.document().setDefaultTextOption(option)
class LineNumbers(object):  # tag:CodeEditor
...
class BreakPoints(object):  # tag:CodeEditor
...
class Wrap(object): # tag:CodeEditor
