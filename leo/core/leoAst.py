...
class Orange:
    ...
    def beautify(self,
        contents: str,
        filename: str,
        tokens: list[Token],  ### list[InputToken],
    ...
    def beautify_file(self, filename: str) -> bool:  # pragma: no cover
        ...
        # Beautify.
        try:
            ### Eventually we will not use the TOG at all.
    ...
    def init_tokens_from_file(self, filename: str) -> tuple[str, str, list[Token]]:  # pragma: no cover  list[InputToken]
        ...
        return contents, encoding, tokens
    #@+node:ekr.20240104123947.1: *4* orange.make_tokens
    ### For now, Orange will use Tokens, not InputTokens.

    def make_tokens(self, contents: str) -> list[Token]:  ### list[InputToken]:
        """
        Return a list (not a generator) of Token objects corresponding to the
        list of 5-tuples generated by tokenize.tokenize.
    ...
    def word_op(self, s: str) -> None:
        ...
        self.blank()
    #@+node:ekr.20200118120049.1: *3* orange: Split/join
    #@+node:ekr.20200107165250.34: *4* orange.split_line & helpers
    ...
    def find_line_prefix(self, token_list: list[OutputToken]) -> list[OutputToken]:
        ...
        for t in token_list:
            ...
            if t.kind == 'lt':
                break
        return result
    #@+node:ekr.20200107165250.39: *4* orange.join_lines
