...
if use_external:
    ...
    pass # Use the (presently disabled) classes.
...
class cacher:
    ...
    #@-others
#@-node:ekr.20100208062523.5885:class cacher
#@+node:ekr.20100208103105.6115:class path (not used)
if 0:
    class path(_base):
        """
        ...
        #@-others
#@-node:ekr.20100208103105.6115:class path (not used)
#@+node:ekr.20100208103105.5992:class PickleShareDB (not used)
if 0:
    _sentinel = object()
    ...
    class PickleShareDB:
        ...
        #@-others
#@-node:ekr.20100208103105.5992:class PickleShareDB (not used)
#@+node:ekr.20100208103105.6017:class PickleShareLink (not used)
if 0:
    class PickleShareLink:
        ...
        #@-others
#@-node:ekr.20100208103105.6017:class PickleShareLink (not used)
#@+node:ekr.20100208103105.6029:path methods referenced by pickleShare (not used)
if 0:
    #@    @+others
