...
class RstCommands:
        ...
        while p and p != after:
            ...
            if g.match_word(h, 0, '@rst-ignore-tree'):
                ...
                if ((fn and fn[0] != '-') or (toString and not fn)):
                    self.write_rst_tree(p, ext, fn, toString=toString)
    ...
    def write_rst_tree(self, p, ext, fn, toString=False): ###, justOneFile=False):
        ...
        if self.call_docutils or self.write_intermediate_file:
            self.write_files(ext, fn, p, source, toString)
    ...
    def write_slides(self, p, toString=False):
        ...
        for child in p.children():
            ...
            source = self.compute_result()
            self.write_files(ext, fn2, p, souurce, toString=toString)
    ...
    def write_files(self, ext, fn, p, source, toString):
