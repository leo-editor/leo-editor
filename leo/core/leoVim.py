...
if 0: # Don't execute this code when loading the file!
    #@+others
    #@+node:ekr.20131111054309.16527: *3* @testsetup
    ...
    import string # done in leoVim.py
    import time
    trace_time = True
    #@+others
    #@+node:ekr.20131109170017.16505: *4* class VimCommands
    class VimCommands:
        #@+others
        #@+node:ekr.20131109170017.16507: *5* ctor
        def __init__(self,c):
        ...
        def exec_(self,s):
            ...
            g.trace(s)
        #@+node:ekr.20131109170017.46985: *5* vc.getData
        def getData(self,s):
    ...
    #@+node:ekr.20131111054309.16526: *3* @test vim.exec
    import string # done in leoVim.py
    #@+others
    #@+node:ekr.20131109170017.16505: *4* class VimCommands
    class VimCommands:
