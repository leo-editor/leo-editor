...
class LeoQtColorizer(object):
    ...
    For the Pyzo colorizer, the interface consists only of an instance
    of PyzoColorizer.
        
    For Leo's legacy colorizer, the interface consists of:
...
if pyzo:
    ...
    class LeoHighlighter(base_highlighter):
            ...
            if self.colorizer.enabled and self.hasCurrentBlock:
                ...
                try:
                    ...
                    if False and ( ### No longer used.
                        ...
                        if trace: g.trace(base_highlighter.__name__)
        ...
        #@+node:ekr.20121003051050.10201: *4* leoh.rehighlight_with_cache (no longer used)
