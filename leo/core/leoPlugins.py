...
if use_class:
    def init():
        g.trace('***leoPlugins.init***')
        g.app.leoPlugins = g.app.leoPluginsController = LeoPluginsController()
else:    
    def init():
...
#@+node:ekr.20100908125007.6039: ** registerHandler
if use_class:
    def registerHandler(tags,fn):
        return g.app.leoPlugins.registerHandler(tags,fn)
