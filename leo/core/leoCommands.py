...
class Commands:
    ...
    __slots__ = (
        ...
        #@+node:ekr.20240522084533.1: *3* << class Commands: slots >>
        # Defined in __init__
        '_currentPosition',
        '_topPosition',
        'command_count',
        ...
        # Defined in c.initDebugIvars.
        'command_count',
        'scanAtPathDirectivesCount',
        'trace_focus_count',

        # Defined in cinitDocumentIvars.
        'expansionLevel',
        'expansionNode',
        ...
        'mFileName',
        'mRelativeFileName',
        'orphan_at_file_nodes',

        # Defined in initObjects.
        'configurables',
        'db',
        'frame',
        'free_layout',
        ...
        # Defined in c.initConfigSettings.
        ...
        # Set in c.setWindowPosition
        'fixedWindowPositionData',
        'windowPosition',

        # Set in c.finishCreate.
        'miniBufferWidget',
        ...
        # Set in various places, including plugins.
        '_prev_next',
        '_style_deltas',
        'active_stylesheet',
        'in_qt_dialog',
        ...
        # Set in plugins.
        ### These should use a more general mechanism.
        '__active_path',
        '_at_produce_count',
        '_at_produce_max',
        '_bookmarks',
        ...
        'opmlCommands',
        'opmlController',
        'patched_quicksearch_controller',
        'pluginsMenu',
        'quickMove',
        'script_io_to_body_oldexec',
        'script_io_to_body_oldput',
        'script_io_to_body_oldputnl',
        'screenCastController',
        'screencast_controller',
        'tableController',
        'tabula',
        'theDateNodesController',
        'theNodeDiffController',
        'theNodewatchController',
        'theRSSController',
