...
class AstBaseTraverser:
    ...
    def op_name (self,node,strict=True):
        ...
        return name
    #@-others
#@+node:ekr.20140526082700.17173: *3* .class AstFullTraverser (AstBaseTraverser)
class AstFullTraverser(AstBaseTraverser):
    ...
    '''
    #@+others
    #@+node:ekr.20140526144610.18280: *4*  ft.ctor
    def __init__ (self):
        pass
...
class AllStatementsTraverser(AstBaseTraverser):
    '''A class that visits all statements.'''
    #@+others
...
class StatementTraverser(AstBaseTraverser):
    '''A class that visits statements.'''
    #@+others
...
class BuildTables:
    ...
    #@-others
#@+node:ekr.20140526082700.18100: ** class HTMLReportTraverser (AstFullTraverser)
class HTMLReportTraverser (AstFullTraverser):
    ...
    '''
    #@+<< copyright notice >>
    #@+node:ekr.20140526082700.17154: *3* << copyright notice >>
    #@@nocolor-node
    #@+at
    ...
    def report_all_modules(self,directory,root_d):
    ...
    #@-others
#@+node:ekr.20140526082700.17346: ** class P1 (AstFullTraverser)
    ...
    **Important**: Injecting empty lists, dicts or sets causes gc problems.
    ...
    def do_Name(self,node):
        ...
        if isinstance(node.ctx,(ast.Param,ast.Store)):
            ...
            node.stc_scope = None
    #@-others
#@+node:ekr.20140526082700.17362: ** class PatternFormatter (AstFormatter)
class PatternFormatter (AstFormatter):
    ...
    #@-others
#@+node:ekr.20140526082700.17364: ** class SSA_Traverser (AstFullTraverser)
class SSA_Traverser(AstFullTraverser):
    ...
    #@-others
#@+node:ekr.20140526082700.17390: ** class Stats (BaseStats)
...
class Utils:
    ...
    def p01_report(self,n,t0,t1,tot_t,n_attrs=None,n_nodes=None):
        ...
        if not g.app.runningAllUnitTests:
            ...
            print('  tot: %s' % tot_t)
    #@+node:ekr.20140526082700.17479: *4* u.p012_report (not used)
