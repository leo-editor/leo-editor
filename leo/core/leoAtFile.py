...
class AtFile(object):
    ...
    #@+node:ekr.20190111151016.1: *5* at.XToString...
    ...
    def stringToString(self, root, s, forcePythonSentinels=True, sentinels=True):
        ...
        try:
            ...
            at.exception("exception preprocessing script")
            return g.u('')
    #@+node:ekr.20190111151048.1: *5* at.writeX...
    ...
    #@+node:ekr.20190111151158.1: *5* at.commands...
    #@+node:ekr.20070806105859: *6* write-at-auto-nodes & write-dirty-at-auto-nodes
    ...
    def writeDirtyAtAutoNodes(self, event=None):
        ...
        c.raise_error_dialogs(kind='write')
    #@+node:ekr.20080711093251.3: *6* write-at-shadow-nodes & write-dirty-at-auto-nodes
    ...
    def writeOneAtShadowNode(self, p, testing=False):
        ...
        try:
            ...
            at.writeException(root)
            return False
    #@+node:ekr.20080819075811.13: *8* at.adjustTargetLanguage
    ...
    #@+node:ekr.20080712150045.3: *8* at.closeAtShadowStringFile
    def closeAtShadowStringFile(self, theFile):
        ...
        return s
    #@+node:ekr.20080712150045.2: *8* at.openAtShadowStringFile
