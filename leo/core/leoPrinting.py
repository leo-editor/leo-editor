...
class PrintingController:
    ...
    @cmd('preview-body')
    def preview_body(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('preview-html')
    def preview_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def preview_expanded_body(self, event: LeoKeyEvent) -> None:
    ...
    def preview_expanded_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def preview_marked_bodies(self, event: LeoKeyEvent) -> None:
    ...
    def preview_marked_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def preview_marked_nodes(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('preview-node')
    def preview_node(self, event: LeoKeyEvent) -> None:
    ...
    def preview_tree_bodies(self, event: LeoKeyEvent) -> None:
    ...
    def preview_tree_nodes(self, event: LeoKeyEvent) -> None:
    ...
    def preview_tree_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    @cmd('print-body')
    def print_body(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('print-html')
    def print_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def print_expanded_body(self, event: LeoKeyEvent) -> None:
    ...
    def print_expanded_html(self, event: LeoKeyEvent) -> None:
        """
        Preview all the expanded bodies of the selected node as html. The
        expanded text must be valid html, including <html> and <body> elements.
        """
    ...
    def print_marked_bodies(self, event: LeoKeyEvent) -> None:
    ...
    def print_marked_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def print_marked_nodes(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('print-node')
    def print_node(self, event: LeoKeyEvent) -> None:
    ...
    def print_tree_bodies(self, event: LeoKeyEvent) -> None:
    ...
    @cmd('print-tree-html')
    def print_tree_html(self, event: LeoKeyEvent) -> None:
        """
    ...
    def print_tree_nodes(self, event: LeoKeyEvent) -> None:
