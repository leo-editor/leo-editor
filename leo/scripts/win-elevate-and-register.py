...
sc_path = os.path.realpath(os.path.join(leo.__path__[0], 'scripts'))
elevate = os.path.join(sc_path, 'elevate.py')
register = os.path.join(sc_path, 'win-register-leo.leox')
unregister = os.path.join(sc_path, 'win-unregister-leo.leox')
