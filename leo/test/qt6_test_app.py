# -*- coding: utf-8 -*-
#@+leo-ver=5-thin
#@+node:ekr.20220911090344.1: * @file ../test/qt6_test_app.py
#@@first

#@+<< qt6_test_app imports >>
#@+node:ekr.20220911090550.1: ** << qt6_test_app imports >>
# Required imports
...
if 0:
    ...
    try:
        ...
        QtNetwork = None
#@-<< qt6_test_app imports >>
#@+<< qt6_test_app enumerations >>
#@+node:ekr.20220911090613.1: ** << qt6_test_app enumerations >>
...
#@-<< qt6_test_app enumerations >>
#@+<< qt6_test_app asserts >>
#@+node:ekr.20220911091013.1: ** << qt6_test_app asserts >>
assert QAction
assert QActionGroup
assert QCloseEvent
assert QUrl
