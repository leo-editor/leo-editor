...
class CursesTree (leoFrame.LeoTree):
    ...
    def showPopupMenu(self, event):
        """Show a popup menu."""
    #@+node:ekr.20170511101300.1: *3* CTree.Items (To be deleted)
    ...
    if 0:
        ...
        ### Note: The unit tests asserts that p.v = item2vnode(position2item(p))
        ...
        def item2vnode(self, item):
            ...
            ###
                # itemHash = self.itemHash(item)
                # return self.item2vnodeDict.get(itemHash)
