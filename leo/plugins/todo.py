#@+leo-ver=4-thin
#@+node:tbrown.20090119132609.65:@thin todo.py
#@<< docstring >>
#@+node:tbrown.20090119132609.66:<< docstring >>
...
class todoController:
    ...
    #@    @+others
    #@+node:tbrown.20090119132609.73:priority table
    priorities = {
    ...
    #@-node:tbrown.20090119132609.73:priority table
    #@+node:tbrown.20090119132609.74:birth
    def __init__ (self,c):
        ...
        #@+node:tbrown.20090119132609.75:<< set / read default values >>
        self.time_name = 'days'
        ...
        self.loadAllIcons()
    #@-node:tbrown.20090119132609.74:birth
    #@+node:tbrown.20090119132609.76:redrawer
    def redrawer(fn):
        ...
        return new
    #@-node:tbrown.20090119132609.76:redrawer
    #@+node:tbrown.20090119132609.77:projectChanger
    ...
    #@nonl
    #@-node:tbrown.20090119132609.77:projectChanger
    #@+node:tbrown.20090119132609.78:loadAllIcons
    @redrawer
    ...
    #@-node:tbrown.20090119132609.78:loadAllIcons
    #@+node:tbrown.20090119132609.79:loadIcons
    @redrawer
    ...
    #@-at
    #@nonl
    #@+node:tbrown.20090119132609.82:delUD
    ...
    #@-node:tbrown.20090119132609.82:delUD
    #@+node:tbrown.20090119132609.83:hasUD
    ...
    #@nonl
    #@-node:tbrown.20090119132609.83:hasUD
    #@+node:tbrown.20090119132609.84:getat
    ...
    #@nonl
    #@-node:tbrown.20090119132609.84:getat
    #@+node:tbrown.20090119132609.85:testDefault
    ...
    #@nonl
    #@-node:tbrown.20090119132609.85:testDefault
    #@+node:tbrown.20090119132609.86:setat
    ...
    #@-node:tbrown.20090119132609.86:setat
    #@+node:tbrown.20090119134723.10:dropEmpty
    def dropEmpty(self, node, dictOk = False):
        ...
        return False
    #@-node:tbrown.20090119134723.10:dropEmpty
    #@+node:tbrown.20090119132609.87:safe_del
    ...
    #@-node:tbrown.20090119132609.87:safe_del
    #@-node:tbrown.20090119132609.81:attributes...
    #@+node:tbrown.20090119132609.88:drawing...
    #@+node:tbrown.20090119132609.89:redraw
    def redraw(self):

        self.updateUI()
        self.c.redraw_now()
    #@-node:tbrown.20090119132609.89:redraw
    #@+node:tbrown.20090119132609.90:clear_all
    @redrawer
    ...
    #@-node:tbrown.20090119132609.90:clear_all
    #@-node:tbrown.20090119132609.88:drawing...
    #@+node:tbrown.20090119134723.11:Progress/time/project...
    #@+node:tbrown.20090119132609.93:progress_clear
    @redrawer
    @projectChanger
    ...
    #@-node:tbrown.20090119132609.93:progress_clear
    #@+node:tbrown.20090119132609.94:set_progress
    @redrawer
    @projectChanger
    ...
    #@-node:tbrown.20090119132609.94:set_progress
    #@+node:tbrown.20090119132609.95:set_time_req
    @redrawer
    @projectChanger
    ...
    #@-node:tbrown.20090119132609.95:set_time_req
    #@+node:tbrown.20090119132609.96:show_times
    @redrawer
    ...
    #@-node:tbrown.20090119132609.96:show_times
    #@+node:tbrown.20090119132609.97:recalc_time
    def recalc_time(self, p=None, clear=False):
        ...
        return (time_totl, time_done)
    #@-node:tbrown.20090119132609.97:recalc_time
    #@+node:tbrown.20090119132609.98:clear_time_req
    @redrawer
    @projectChanger
    def clear_time_req(self, p=None):
        ...
        self.setat(v, 'time_req', '')
    #@-node:tbrown.20090119132609.98:clear_time_req
    #@+node:tbrown.20090119132609.99:update_project
    @redrawer
    ...
    #@-node:tbrown.20090119132609.99:update_project
    #@+node:tbrown.20090119134723.8:local_recalc
    @redrawer
    def local_recalc(self, p=None):
        self.recalc_time(p)
    #@-node:tbrown.20090119134723.8:local_recalc
    #@+node:tbrown.20090119134723.7:local_clear
    @redrawer
    def local_clear(self, p=None):
        self.recalc_time(p, clear=True)
    #@-node:tbrown.20090119134723.7:local_clear
    #@-node:tbrown.20090119134723.11:Progress/time/project...
    #@+node:tbrown.20090119134723.12:ToDo icon related...
    #@+node:tbrown.20090119134723.13:childrenTodo
    @redrawer
    ...
    #@nonl
    #@-node:tbrown.20090119134723.13:childrenTodo
    #@+node:tbrown.20090119132609.100:find_todo
    @redrawer
    def find_todo(self, p=None, stage = 0):
        ...
        return False
    #@-node:tbrown.20090119132609.100:find_todo
    #@+node:tbrown.20090119134723.2:pricmp
    def pricmp(self, a, b):
    ...
    #@nonl
    #@-node:tbrown.20090119134723.2:pricmp
    #@+node:tbrown.20090119134723.14:priority_clear
    @redrawer
    ...
    #@-node:tbrown.20090119134723.14:priority_clear
    #@+node:tbrown.20090119134723.3:priSort
    @redrawer
    ...
    #@nonl
    #@-node:tbrown.20090119134723.3:priSort
    #@+node:tbrown.20090119134723.6:reclassify
    @redrawer
    ...
    #@nonl
    #@-node:tbrown.20090119134723.6:reclassify
    #@+node:tbrown.20090119134723.15:setPri
    @redrawer
    def setPri(self,pri):
        p = self.c.currentPosition()
        ...
        self.loadIcons(p)
    #@-node:tbrown.20090119134723.15:setPri
    #@+node:tbrown.20090119134723.5:showDist
    ...
    #@-node:tbrown.20090119134723.5:showDist
    #@-node:tbrown.20090119134723.12:ToDo icon related...
    #@+node:tbrown.20090119132609.101:updateUI
