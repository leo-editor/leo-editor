...
class MoveLinesUpDown(object): # tag:CodeEditor
...
class ScrollWithUpDownKeys(object): # tag:CodeEditor
    ...
    def keyPressEvent(self,event):
        if event.key() in (Qt.Key_Up, Qt.Key_Down) and Qt.ControlModifier == event.modifiers():
            ...
            super().keyPressEvent(event)
class HomeKey(object): # tag:CodeEditor
    ...
    def keyPressEvent(self,event):
        ...
        if event.key() == Qt.Key_Home and \
            ...
            super().keyPressEvent(event)
class EndKey(object): # tag:CodeEditor
    ...
    def keyPressEvent(self,event):
        if event.key() == Qt.Key_End and \
            ...
            super().keyPressEvent(event)
class NumpadPeriodKey(object): # tag:CodeEditor
    """
    ...
    def keyPressEvent(self,event):
        ...
        super().keyPressEvent(event)
class Indentation(object): # tag:CodeEditor
    ...
    def keyPressEvent(self,event):
        ...
        super().keyPressEvent(event)
class AutoIndent(object): # tag:CodeEditor
    """
...
class PythonAutoIndent(object): # tag:CodeEditor
    ...
    def keyPressEvent(self,event):
        ...
        if event.key() in (Qt.Key_Enter,Qt.Key_Return):
            ...
            if previousBlock.isValid():
                ...
                self.setTextCursor(cursor)
class SmartCopyAndPaste(object): # tag:CodeEditor
    """
    ...
    def _paste(self, keepSelection):
        ...
        if keepSelection:
            ...
            self.setTextCursor(cursor)
class AutoCloseQuotesAndBrackets(object): # tag:CodeEditor
    """
