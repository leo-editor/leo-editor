...
#@<< swing imports >>
#@+node:ekr.20081004102201.732:<< swing imports >>
...
class leoSwingDialog:
    ...
    #@    @+others
    #@+node:ekr.20081004102201.682:__init__ (tkDialog)
    ...
    #@-node:ekr.20081004102201.682:__init__ (tkDialog)
    #@+node:ekr.20081004102201.683:cancelButton, noButton, okButton, yesButton
    ...
    def yesButton(self):
        ...
        self.top.destroy()
    #@-node:ekr.20081004102201.683:cancelButton, noButton, okButton, yesButton
    #@+node:ekr.20081004102201.684:center
    def center(self):
    ...
    #@-node:ekr.20081004102201.684:center
    #@+node:ekr.20081004102201.685:createButtons
    def createButtons (self,buttons):
        ...
        return buttonList
    #@-node:ekr.20081004102201.685:createButtons
    #@+node:ekr.20081004102201.686:createMessageFrame
    def createMessageFrame (self,message):
        ...
        label.pack(pady=10)
    #@-node:ekr.20081004102201.686:createMessageFrame
    #@+node:ekr.20081004102201.687:createTopFrame
    ...
    #@-node:ekr.20081004102201.687:createTopFrame
    #@+node:ekr.20081004102201.688:onClose
    def onClose (self):
        ...
        pass
    #@-node:ekr.20081004102201.688:onClose
    #@+node:ekr.20081004102201.689:run (tkDialog)
    def run (self,modal):
    ...
    #@-others
#@-node:ekr.20081004102201.681: class leoSwingDialog
#@+node:ekr.20081004102201.690:class swingAboutLeo
class swingAboutLeo (leoSwingDialog):

    """A class that creates the swing About Leo dialog."""

    #@    @+others
    #@+node:ekr.20081004102201.691:swingAboutLeo.__init__
    def __init__ (self,c,version,theCopyright,url,email):
        ...
        self.createFrame()
    #@-node:ekr.20081004102201.691:swingAboutLeo.__init__
    #@+node:ekr.20081004102201.692:swingAboutLeo.createFrame
    ...
    #@-node:ekr.20081004102201.692:swingAboutLeo.createFrame
    #@+node:ekr.20081004102201.693:swingAboutLeo.onAboutLeoEmail
    ...
    #@-node:ekr.20081004102201.693:swingAboutLeo.onAboutLeoEmail
    #@+node:ekr.20081004102201.694:swingAboutLeo.onAboutLeoUrl
    ...
    #@-node:ekr.20081004102201.694:swingAboutLeo.onAboutLeoUrl
    #@+node:ekr.20081004102201.695:swingAboutLeo: setArrowCursor, setDefaultCursor
    ...
    #@-others
#@-node:ekr.20081004102201.690:class swingAboutLeo
#@+node:ekr.20081004102201.696:class swingAskLeoID
class swingAskLeoID (leoSwingDialog):

    """A class that creates the swing About Leo dialog."""

    #@    @+others
    #@+node:ekr.20081004102201.697:swingAskLeoID.__init__
    ...
    #@-node:ekr.20081004102201.697:swingAskLeoID.__init__
    #@+node:ekr.20081004102201.698:swingAskLeoID.createFrame
    def createFrame(self,message):
        ...
        text.pack()
    #@-node:ekr.20081004102201.698:swingAskLeoID.createFrame
    #@+node:ekr.20081004102201.699:swingAskLeoID.onButton
    def onButton(self):
        ...
        self.top = None
    #@-node:ekr.20081004102201.699:swingAskLeoID.onButton
    #@+node:ekr.20081004102201.700:swingAskLeoID.onKey
    def onKey(self,event):

        """Handle keystrokes in the Leo Id dialog."""

        #@    << eliminate invalid characters >>
        #@+node:ekr.20081004102201.701:<< eliminate invalid characters >>
        e = self.id_entry
        s = e.get().strip()
        i = 0 ; ok = True
        while i < len(s):
        ...
        #@+node:ekr.20081004102201.702:<< enable the ok button if there are 3 or more valid characters >>
        e = self.id_entry
        b = self.ok_button
    ...
    #@-others
#@-node:ekr.20081004102201.696:class swingAskLeoID
#@+node:ekr.20081004102201.703:class swingAskOk
class swingAskOk(leoSwingDialog):

    """A class that creates a swing dialog with a single OK button."""

    #@    @+others
    #@+node:ekr.20081004102201.704:class swingAskOk.__init__
    ...
    #@-node:ekr.20081004102201.704:class swingAskOk.__init__
    #@+node:ekr.20081004102201.705:class swingAskOk.onKey
    def onKey(self,event):
    ...
    #@-others
#@-node:ekr.20081004102201.703:class swingAskOk
#@+node:ekr.20081004102201.706:class swingAskOkCancelNumber
class  swingAskOkCancelNumber (leoSwingDialog):

    """Create and run a modal swing dialog to get a number."""

    #@    @+others
    #@+node:ekr.20081004102201.707:swingAskOKCancelNumber.__init__
    ...
    #@-node:ekr.20081004102201.707:swingAskOKCancelNumber.__init__
    #@+node:ekr.20081004102201.708:swingAskOKCancelNumber.createFrame
    def createFrame (self,message):
        ...
        c.set_focus(w)
    #@-node:ekr.20081004102201.708:swingAskOKCancelNumber.createFrame
    #@+node:ekr.20081004102201.709:swingAskOKCancelNumber.okButton, cancelButton
    def okButton(self):
    ...
    def cancelButton(self):
        ...
        self.top.destroy()
    #@-node:ekr.20081004102201.709:swingAskOKCancelNumber.okButton, cancelButton
    #@+node:ekr.20081004102201.710:swingAskOKCancelNumber.onKey
    def onKey (self,event):

        #@    << eliminate non-numbers >>
        #@+node:ekr.20081004102201.711:<< eliminate non-numbers >>
        e = self.number_entry
        s = e.get().strip()
    ...
    #@-others
#@-node:ekr.20081004102201.706:class swingAskOkCancelNumber
#@+node:ekr.20081004102201.712:class swingAskOkCancelString
class  swingAskOkCancelString (leoSwingDialog):

    """Create and run a modal swing dialog to get a string."""

    #@    @+others
    #@+node:ekr.20081004102201.713:swingAskOKCancelString.__init__
    def __init__ (self,c,title,message):
        ...
        self.ok_button = buttonList[0] # Override the default kind of Ok button.
    #@-node:ekr.20081004102201.713:swingAskOKCancelString.__init__
    #@+node:ekr.20081004102201.714:swingAskOkCancelString.createFrame
    def createFrame (self,message):
        ...
        c.set_focus(w)
    #@-node:ekr.20081004102201.714:swingAskOkCancelString.createFrame
    #@+node:ekr.20081004102201.715:swingAskOkCancelString.okButton, cancelButton
    def okButton(self):
    ...
    def cancelButton(self):
        ...
        self.top.destroy()
    #@-node:ekr.20081004102201.715:swingAskOkCancelString.okButton, cancelButton
    #@+node:ekr.20081004102201.716:swingAskOkCancelString.onKey
    def onKey (self,event):
    ...
    #@-others
#@-node:ekr.20081004102201.712:class swingAskOkCancelString
#@+node:ekr.20081004102201.717:class swingAskYesNo
class swingAskYesNo (leoSwingDialog):

    """A class that creates a swing dialog with two buttons: Yes and No."""

    #@    @+others
    #@+node:ekr.20081004102201.718:swingAskYesNo.__init__
    def __init__ (self,c,title,message=None,resizeable=False):
        ...
        self.createButtons(buttons)
    #@-node:ekr.20081004102201.718:swingAskYesNo.__init__
    #@+node:ekr.20081004102201.719:swingAskYesNo.onKey
    def onKey(self,event):
    ...
    #@-others
#@-node:ekr.20081004102201.717:class swingAskYesNo
#@+node:ekr.20081004102201.720:class swingAskYesNoCancel
class swingAskYesNoCancel(leoSwingDialog):
    ...
    #@    @+others
    #@+node:ekr.20081004102201.721:askYesNoCancel.__init__
    def __init__ (self,c,title,
        ...
        self.createButtons(buttons)
    #@-node:ekr.20081004102201.721:askYesNoCancel.__init__
    #@+node:ekr.20081004102201.722:askYesNoCancel.onKey
    def onKey(self,event):
        ...
        return "break"
    #@-node:ekr.20081004102201.722:askYesNoCancel.onKey
    #@+node:ekr.20081004102201.723:askYesNoCancel.noButton & yesButton
    def noButton(self):
    ...
    #@-others
#@-node:ekr.20081004102201.720:class swingAskYesNoCancel
#@+node:ekr.20081004102201.724:class swingListboxDialog
class swingListBoxDialog (leoSwingDialog):

    """A base class for swing dialogs containing a Tk Listbox"""

    #@    @+others
    #@+node:ekr.20081004102201.725:swingListboxDialog.__init__
    ...
    #@-node:ekr.20081004102201.725:swingListboxDialog.__init__
    #@+node:ekr.20081004102201.726:addStdButtons
    ...
    #@-node:ekr.20081004102201.726:addStdButtons
    #@+node:ekr.20081004102201.727:createFrame
    def createFrame(self):
    ...
    #@-node:ekr.20081004102201.727:createFrame
    #@+node:ekr.20081004102201.728:destroy
    ...
    #@-node:ekr.20081004102201.728:destroy
    #@+node:ekr.20081004102201.729:hide
    def hide (self):
        ...
        self.top.withdraw()
    #@-node:ekr.20081004102201.729:hide
    #@+node:ekr.20081004102201.730:fillbox
    def fillbox(self,event=None):
        ...
        pass
    #@-node:ekr.20081004102201.730:fillbox
    #@+node:ekr.20081004102201.731:go
...
#@-node:ekr.20081004102201.724:class swingListboxDialog
#@-node:ekr.20081004102201.680:leoSwingDialog
#@+node:ekr.20081004102201.734:leoSwingFrame
#@+node:ekr.20081004102201.736:class leoSwingFrame
class leoSwingFrame (leoFrame.leoFrame):

    #@    @+others
    #@+node:ekr.20081004102201.737: Birth & Death (swingFrame)
    #@+node:ekr.20081004102201.738:__init__ (swingFrame)
    def __init__(self,title,gui):
        ...
        #@+node:ekr.20081004102201.739:<< set the leoSwingFrame ivars >> (removed frame.bodyCtrl ivar)
        ...
        #@nl
    #@-node:ekr.20081004102201.738:__init__ (swingFrame)
    #@+node:ekr.20081004102201.740:__repr__ (swingFrame)
    def __repr__ (self):

        return "<leoSwingFrame: %s>" % self.title
    #@-node:ekr.20081004102201.740:__repr__ (swingFrame)
    #@+node:ekr.20081004102201.741:swingFrame.finishCreate & helpers
    def finishCreate (self,c):
        ...
        c.bodyWantsFocusNow()
    #@+node:ekr.20081004102201.742:createOuterFrames
    ...
    #@-node:ekr.20081004102201.742:createOuterFrames
    #@+node:ekr.20081004102201.743:createSplitterComponents (removed frame.bodyCtrl ivar)
    ...
    #@-node:ekr.20081004102201.743:createSplitterComponents (removed frame.bodyCtrl ivar)
    #@+node:ekr.20081004102201.744:createFirstTreeNode
    ...
    #@-node:ekr.20081004102201.744:createFirstTreeNode
    #@-node:ekr.20081004102201.741:swingFrame.finishCreate & helpers
    #@+node:ekr.20081004102201.745:swingFrame.createCanvas & helpers
    def createCanvas (self,parentFrame,pack=True):
        ...
        return canvas
    #@nonl
    #@+node:ekr.20081004102201.746:f.createTkTreeCanvas & callbacks
    def createTkTreeCanvas (self,parentFrame,scrolls,pack):
        ...
        if sys.platform != "win32": # Works on 98, crashes on XP.
            ...
            if 1: # New in 4.3.
                ...
                #@+node:ekr.20081004102201.747:<< workaround for mouse-wheel problems >>
        ...
        if 0:
            ...
            #@+node:ekr.20081004102201.748:<< do scrolling by hand in a separate thread >>
        ...
        return canvas
    #@+node:ekr.20081004102201.749:Scrolling callbacks (swingFrame)
    ...
    #@-node:ekr.20081004102201.749:Scrolling callbacks (swingFrame)
    #@-node:ekr.20081004102201.746:f.createTkTreeCanvas & callbacks
    #@+node:ekr.20081004102201.750:f.setCanvasColorFromConfig
    ...
    #@-node:ekr.20081004102201.750:f.setCanvasColorFromConfig
    #@-node:ekr.20081004102201.745:swingFrame.createCanvas & helpers
    #@+node:ekr.20081004102201.751:swingFrame.createLeoSplitters & helpers
    #@+at 
    #@nonl
    ...
    #@nonl
    #@+node:ekr.20081004102201.752:createLeoSwingSplitter
    def createLeoSwingSplitter (self,parent,verticalFlag,componentName):
        ...
        # return f, bar, f1, f2
    #@-node:ekr.20081004102201.752:createLeoSwingSplitter
    #@+node:ekr.20081004102201.753:bindBar
    ...
    #@-node:ekr.20081004102201.753:bindBar
    #@+node:ekr.20081004102201.754:divideAnySplitter
    ...
    #@-node:ekr.20081004102201.754:divideAnySplitter
    #@+node:ekr.20081004102201.755:divideLeoSplitter
    ...
    #@-node:ekr.20081004102201.755:divideLeoSplitter
    #@+node:ekr.20081004102201.756:onDrag...
    ...
    #@-node:ekr.20081004102201.756:onDrag...
    #@+node:ekr.20081004102201.757:placeSplitter
    ...
    #@-node:ekr.20081004102201.757:placeSplitter
    #@-node:ekr.20081004102201.751:swingFrame.createLeoSplitters & helpers
    #@+node:ekr.20081004102201.758:Destroying the swingFrame
    #@+node:ekr.20081004102201.759:destroyAllObjects
    def destroyAllObjects (self):
        ...
        #@+node:ekr.20081004102201.760:<< clear all vnodes and tnodes in the tree>>
    ...
    #@-node:ekr.20081004102201.759:destroyAllObjects
    #@+node:ekr.20081004102201.761:destroyAllPanels
    def destroyAllPanels (self):
        ...
        for panel in panels:
            if panel:
                panel.top.destroy()
    #@-node:ekr.20081004102201.761:destroyAllPanels
    #@+node:ekr.20081004102201.762:destroySelf (swingFrame)
    ...
    #@-node:ekr.20081004102201.758:Destroying the swingFrame
    #@-node:ekr.20081004102201.737: Birth & Death (swingFrame)
    #@+node:ekr.20081004102201.763:class swingStatusLineClass
    class swingStatusLineClass:

        '''A class representing the status line.'''

        #@    @+others
        #@+node:ekr.20081004102201.764: ctor
        ...
        #@-node:ekr.20081004102201.764: ctor
        #@+node:ekr.20081004102201.765:clear
        def clear (self):
            ...
            w.configure(state="disabled")
        #@-node:ekr.20081004102201.765:clear
        #@+node:ekr.20081004102201.766:enable, disable & isEnabled
        ...
        #@nonl
        #@-node:ekr.20081004102201.766:enable, disable & isEnabled
        #@+node:ekr.20081004102201.767:get
        def get (self):
            ...
            if w:
                ...
                return ""
        #@-node:ekr.20081004102201.767:get
        #@+node:ekr.20081004102201.768:getFrame
        def getFrame (self):

            return self.statusFrame
        #@-node:ekr.20081004102201.768:getFrame
        #@+node:ekr.20081004102201.769:onActivate
        ...
        #@-node:ekr.20081004102201.769:onActivate
        #@+node:ekr.20081004102201.770:pack & show
        def pack (self):
        ...
        show = pack
        #@-node:ekr.20081004102201.770:pack & show
        #@+node:ekr.20081004102201.771:put (leoSwingFrame:statusLineClass)
        def put(self,s,color=None):
            ...
            w.configure(state="disabled")
        #@-node:ekr.20081004102201.771:put (leoSwingFrame:statusLineClass)
        #@+node:ekr.20081004102201.772:unpack & hide
        def unpack (self):
        ...
        hide = unpack
        #@-node:ekr.20081004102201.772:unpack & hide
        #@+node:ekr.20081004102201.773:update (statusLine)
        def update (self):
        ...
        #@-others
    #@-node:ekr.20081004102201.763:class swingStatusLineClass
    #@+node:ekr.20081004102201.774:class swingIconBarClass
    class swingIconBarClass:

        '''A class representing the singleton Icon bar'''

        #@    @+others
        #@+node:ekr.20081004102201.775: ctor
        def __init__ (self,c,parentFrame):
            ...
            self.show()
        #@-node:ekr.20081004102201.775: ctor
        #@+node:ekr.20081004102201.776:add
        def add(self,*args,**keys):
            ...
            if imagefile or image:
                #@        << create a picture >>
                #@+node:ekr.20081004102201.777:<< create a picture >>
                try:
                    if imagefile:
            ...
            return None
        #@-node:ekr.20081004102201.776:add
        #@+node:ekr.20081004102201.778:clear
        def clear(self):
            ...
            g.app.iconImageRefs = []
        #@-node:ekr.20081004102201.778:clear
        #@+node:ekr.20081004102201.779:deleteButton (new in Leo 4.4.3)
        def deleteButton (self,w):

            w.pack_forget()
        #@-node:ekr.20081004102201.779:deleteButton (new in Leo 4.4.3)
        #@+node:ekr.20081004102201.780:getFrame
        def getFrame (self):

            return self.iconFrame
        #@-node:ekr.20081004102201.780:getFrame
        #@+node:ekr.20081004102201.781:pack (show)
        def pack (self):
        ...
        show = pack
        #@-node:ekr.20081004102201.781:pack (show)
        #@+node:ekr.20081004102201.782:setCommandForButton (new in Leo 4.4.3)
        def setCommandForButton(self,b,command):

            b.configure(command=command)
        #@-node:ekr.20081004102201.782:setCommandForButton (new in Leo 4.4.3)
        #@+node:ekr.20081004102201.783:unpack (hide)
        def unpack (self):
        ...
        #@-others
    #@-node:ekr.20081004102201.774:class swingIconBarClass
    #@+node:ekr.20081004102201.784:Minibuffer methods
    #@+node:ekr.20081004102201.785:showMinibuffer
    ...
    #@-node:ekr.20081004102201.785:showMinibuffer
    #@+node:ekr.20081004102201.786:hideMinibuffer
    ...
    #@-node:ekr.20081004102201.786:hideMinibuffer
    #@+node:ekr.20081004102201.787:f.createMiniBufferWidget
    def createMiniBufferWidget (self):
        ...
        # return label
    #@-node:ekr.20081004102201.787:f.createMiniBufferWidget
    #@+node:ekr.20081004102201.788:f.setMinibufferBindings
    ...
    #@-node:ekr.20081004102201.788:f.setMinibufferBindings
    #@-node:ekr.20081004102201.784:Minibuffer methods
    #@+node:ekr.20081004102201.789:Configuration (swingFrame)
    #@+node:ekr.20081004102201.790:configureBar (swingFrame)
    ...
    #@-node:ekr.20081004102201.790:configureBar (swingFrame)
    #@+node:ekr.20081004102201.791:configureBarsFromConfig (swingFrame)
    def configureBarsFromConfig (self):
        ...
        try:
            ...
            g.es_exception()
    #@-node:ekr.20081004102201.791:configureBarsFromConfig (swingFrame)
    #@+node:ekr.20081004102201.792:reconfigureFromConfig (swingFrame)
    def reconfigureFromConfig (self):
        ...
        c.redraw_now()
    #@-node:ekr.20081004102201.792:reconfigureFromConfig (swingFrame)
    #@+node:ekr.20081004102201.793:setInitialWindowGeometry (swingFrame)
    ...
    #@-node:ekr.20081004102201.793:setInitialWindowGeometry (swingFrame)
    #@+node:ekr.20081004102201.794:setTabWidth (swingFrame)
    def setTabWidth (self, w):
        ...
        # except:
            ...
            # pass
    #@-node:ekr.20081004102201.794:setTabWidth (swingFrame)
    #@+node:ekr.20081004102201.795:setWrap (swingFrame)
    def setWrap (self,p):
    ...
    #@nonl
    #@-node:ekr.20081004102201.795:setWrap (swingFrame)
    #@+node:ekr.20081004102201.796:setTopGeometry (swingFrame)
    ...
    #@-node:ekr.20081004102201.796:setTopGeometry (swingFrame)
    #@+node:ekr.20081004102201.797:reconfigurePanes (use config bar_width) (swingFrame)
    ...
    #@-node:ekr.20081004102201.797:reconfigurePanes (use config bar_width) (swingFrame)
    #@+node:ekr.20081004102201.798:resizePanesToRatio (swingFrame)
    ...
    #@-node:ekr.20081004102201.798:resizePanesToRatio (swingFrame)
    #@-node:ekr.20081004102201.789:Configuration (swingFrame)
    #@+node:ekr.20081004102201.799:Event handlers (swingFrame)
    #@+node:ekr.20081004102201.800:frame.OnCloseLeoEvent
    ...
    #@-node:ekr.20081004102201.800:frame.OnCloseLeoEvent
    #@+node:ekr.20081004102201.801:frame.OnControlKeyUp/Down
    ...
    #@-node:ekr.20081004102201.801:frame.OnControlKeyUp/Down
    #@+node:ekr.20081004102201.802:OnActivateBody (swingFrame)
    def OnActivateBody (self,event=None):
        ...
        return 'break'
    #@-node:ekr.20081004102201.802:OnActivateBody (swingFrame)
    #@+node:ekr.20081004102201.803:OnActivateLeoEvent, OnDeactivateLeoEvent
    ...
    #@-node:ekr.20081004102201.803:OnActivateLeoEvent, OnDeactivateLeoEvent
    #@+node:ekr.20081004102201.804:OnActivateTree
    ...
    #@-node:ekr.20081004102201.804:OnActivateTree
    #@+node:ekr.20081004102201.805:OnBodyClick, OnBodyRClick (Events)
    ...
    #@-node:ekr.20081004102201.805:OnBodyClick, OnBodyRClick (Events)
    #@+node:ekr.20081004102201.806:OnBodyDoubleClick (Events)
    ...
    #@-node:ekr.20081004102201.806:OnBodyDoubleClick (Events)
    #@+node:ekr.20081004102201.807:OnMouseWheel (Tomaz Ficko)
    ...
    #@-node:ekr.20081004102201.807:OnMouseWheel (Tomaz Ficko)
    #@-node:ekr.20081004102201.799:Event handlers (swingFrame)
    #@+node:ekr.20081004102201.808:Gui-dependent commands
    #@+node:ekr.20081004102201.809:Minibuffer commands... (swingFrame)

    #@+node:ekr.20081004102201.810:contractPane
    ...
    #@-node:ekr.20081004102201.810:contractPane
    #@+node:ekr.20081004102201.811:expandPane
    def expandPane (self,event=None):
        ...
        if wname.startswith('body'):
            ...
            f.expandOutlinePane()
    #@-node:ekr.20081004102201.811:expandPane
    #@+node:ekr.20081004102201.812:fullyExpandPane
    ...
    #@-node:ekr.20081004102201.812:fullyExpandPane
    #@+node:ekr.20081004102201.813:hidePane
    def hidePane (self,event=None):
        ...
        if wname.startswith('body'):
            ...
            c.bodyWantsFocusNow()
    #@-node:ekr.20081004102201.813:hidePane
    #@+node:ekr.20081004102201.814:expand/contract/hide...Pane
    #@+at 
    #@nonl
    ...
    #@-node:ekr.20081004102201.814:expand/contract/hide...Pane
    #@+node:ekr.20081004102201.815:fullyExpand/hide...Pane
    ...
    #@-node:ekr.20081004102201.815:fullyExpand/hide...Pane
    #@-node:ekr.20081004102201.809:Minibuffer commands... (swingFrame)
    #@+node:ekr.20081004102201.816:Window Menu...
    #@+node:ekr.20081004102201.817:toggleActivePane
    def toggleActivePane (self,event=None):
        ...
        if c.get_focus() == frame.body.bodyCtrl: # 2007:10/25
            ...
            c.bodyWantsFocusNow()
    #@-node:ekr.20081004102201.817:toggleActivePane
    #@+node:ekr.20081004102201.818:cascade
    def cascade (self,event=None):
        ...
        for frame in g.app.windowList:
            ...
            if x > 200:
                ...
                delta += 10
    #@-node:ekr.20081004102201.818:cascade
    #@+node:ekr.20081004102201.819:equalSizedPanes
    ...
    #@-node:ekr.20081004102201.819:equalSizedPanes
    #@+node:ekr.20081004102201.820:hideLogWindow
    def hideLogWindow (self,event=None):

        frame = self
        frame.divideLeoSplitter2(0.99, not frame.splitVerticalFlag)
    #@-node:ekr.20081004102201.820:hideLogWindow
    #@+node:ekr.20081004102201.821:minimizeAll
    ...
    def minimize(self,frame):
        ...
        if frame and frame.top.state() == "normal":
            frame.top.iconify()
    #@-node:ekr.20081004102201.821:minimizeAll
    #@+node:ekr.20081004102201.822:toggleSplitDirection (swingFrame)
    ...
    #@+node:ekr.20081004102201.823:toggleTkSplitDirection
    ...
    #@-node:ekr.20081004102201.823:toggleTkSplitDirection
    #@-node:ekr.20081004102201.822:toggleSplitDirection (swingFrame)
    #@+node:ekr.20081004102201.824:resizeToScreen
    ...
    #@-node:ekr.20081004102201.824:resizeToScreen
    #@-node:ekr.20081004102201.816:Window Menu...
    #@+node:ekr.20081004102201.825:Help Menu...
    #@+node:ekr.20081004102201.826:leoHelp
        ...
        if g.os_path_exists(theFile):
            ...
            if answer == "yes":
                try:
                    ...
                    g.es_exception()
    #@+node:ekr.20081004102201.827:showProgressBar
    def showProgressBar (self,count,size,total):

        # g.trace("count,size,total:",count,size,total)
        if self.scale == None:
            #@        << create the scale widget >>
            #@+node:ekr.20081004102201.828:<< create the scale widget >>
            top = Tk.Toplevel()
    ...
    #@-node:ekr.20081004102201.825:Help Menu...
    #@-node:ekr.20081004102201.808:Gui-dependent commands
    #@+node:ekr.20081004102201.829:Delayed Focus (swingFrame)
    #@+at 
    #@nonl
    ...
    #@-at
    #@-node:ekr.20081004102201.829:Delayed Focus (swingFrame)
    #@+node:ekr.20081004102201.830:Tk bindings... (swingFrame)
    ...
    #@-others
#@-node:ekr.20081004102201.736:class leoSwingFrame
#@+node:ekr.20081004102201.831:class leoSwingBody
class leoSwingBody (leoFrame.leoBody):
    ...
    #@    @+others
    #@+node:ekr.20081004102201.832: Birth & death
    #@+node:ekr.20081004102201.833:swingBody. __init__
    def __init__ (self,frame,parentFrame):
    ...
    #@-node:ekr.20081004102201.833:swingBody. __init__
    #@+node:ekr.20081004102201.834:swingBody.createBindings
    ...
    #@nonl
    #@-node:ekr.20081004102201.834:swingBody.createBindings
    #@+node:ekr.20081004102201.835:swingBody.createControl
    def createControl (self,parentFrame,p):
        ...
        return w
    #@-node:ekr.20081004102201.835:swingBody.createControl
    #@+node:ekr.20081004102201.836:swingBody.createTextWidget
    ...
    #@-node:ekr.20081004102201.836:swingBody.createTextWidget
    #@-node:ekr.20081004102201.832: Birth & death
    #@+node:ekr.20081004102201.837:swingBody.setColorFromConfig
    ...
    #@-node:ekr.20081004102201.837:swingBody.setColorFromConfig
    #@+node:ekr.20081004102201.838:swingBody.setFontFromConfig
    ...
    #@-node:ekr.20081004102201.838:swingBody.setFontFromConfig
    #@+node:ekr.20081004102201.839:Focus (swingBody)
    def hasFocus (self):
    ...
    #@-node:ekr.20081004102201.839:Focus (swingBody)
    #@+node:ekr.20081004102201.840:forceRecolor
    def forceFullRecolor (self):

        self.forceFullRecolorFlag = True
    #@-node:ekr.20081004102201.840:forceRecolor
    #@+node:ekr.20081004102201.841:Tk bindings (swingBbody)
    #@+node:ekr.20081004102201.842:bind (new)
    def bind (self,*args,**keys):

        pass
    #@-node:ekr.20081004102201.842:bind (new)
    #@+node:ekr.20081004102201.843:Tags (Tk spelling) (swingBody)
    ...
    #@-node:ekr.20081004102201.846:Idle time... (swingBody)
    #@+node:ekr.20081004102201.847:Menus (swingBody)
    def bind (self,*args,**keys):

        pass ### return self.bodyCtrl.bind(*args,**keys)
    #@-node:ekr.20081004102201.847:Menus (swingBody)
    #@+node:ekr.20081004102201.848:Text (now in base class) (swingBody)
    ...
    #@-node:ekr.20081004102201.848:Text (now in base class) (swingBody)
    #@-node:ekr.20081004102201.841:Tk bindings (swingBbody)
    #@+node:ekr.20081004102201.849:Editors (swingBody)
    #@+node:ekr.20081004102201.850:createEditorFrame
    def createEditorFrame (self,pane):
        ...
        return f
    #@-node:ekr.20081004102201.850:createEditorFrame
    #@+node:ekr.20081004102201.851:packEditorLabelWidget
    ...
    #@nonl
    #@-node:ekr.20081004102201.851:packEditorLabelWidget
    #@+node:ekr.20081004102201.852:setEditorColors
    ...
    #@-others
#@-node:ekr.20081004102201.831:class leoSwingBody
#@+node:ekr.20081004102201.853:class leoSwingKeys
...
#@-node:ekr.20081004102201.853:class leoSwingKeys
#@+node:ekr.20081004102201.854:class leoSwingMenu
class leoSwingMenu( leoMenu.leoMenu ):

    #@    @+others
    #@+node:ekr.20081004102201.855: leoSwingMenu.__init__
    ...
    #@-node:ekr.20081004102201.855: leoSwingMenu.__init__
    #@+node:ekr.20081004102201.856:not ready yet
    if 0:
        #@    @+others
        #@+node:ekr.20081004102201.857:class MenuChanger
        ...
        #@-node:ekr.20081004102201.857:class MenuChanger
        #@+node:ekr.20081004102201.858:print menu stuff...

        #@+node:ekr.20081004102201.859:defineLeoSwingPrintTable
        ...
        #@-node:ekr.20081004102201.859:defineLeoSwingPrintTable
        #@+node:ekr.20081004102201.860:createLeoSwingPrintMenu
        ...
        #@-node:ekr.20081004102201.860:createLeoSwingPrintMenu
        #@+node:ekr.20081004102201.861:createLeoSwingPrint
        ...
        #@-node:ekr.20081004102201.861:createLeoSwingPrint
        #@-node:ekr.20081004102201.858:print menu stuff...
        #@+node:ekr.20081004102201.862:plugin menu stuff...
        #@+node:ekr.20081004102201.863:createPluginMenu
        ...
        #@-node:ekr.20081004102201.863:createPluginMenu
        #@+node:ekr.20081004102201.864:createPluginManager
        ...
        #@-node:ekr.20081004102201.864:createPluginManager
        #@+node:ekr.20081004102201.865:getPluginMenu
        def getPluginMenu( self ):

            return self.plugin_menu
        #@-node:ekr.20081004102201.865:getPluginMenu
        #@-node:ekr.20081004102201.862:plugin menu stuff...
        #@+node:ekr.20081004102201.866:JythonShell stuff

        #@+node:ekr.20081004102201.867:openJythonShell
        ...
        #@-node:ekr.20081004102201.867:openJythonShell
        #@+node:ekr.20081004102201.868:addMenuToJythonShell
        ...
        #@-node:ekr.20081004102201.868:addMenuToJythonShell
        #@+node:ekr.20081004102201.869:getInsertNodeIntoShell
        def getInsertNodeIntoShell( self, c, jd ):
            ...
            return jm
        #@-node:ekr.20081004102201.869:getInsertNodeIntoShell
        #@+node:ekr.20081004102201.870:getInsertReferenceIntoLeo
        ...
        #@nonl
        #@-node:ekr.20081004102201.870:getInsertReferenceIntoLeo
        #@+node:ekr.20081004102201.871:getRunNodeInPdb
        def getRunNodeInPdb( self, c, jd ):
            ...
            return runInPdb      
        #@-node:ekr.20081004102201.871:getRunNodeInPdb
        #@+node:ekr.20081004102201.872:fireNodeAsScript
        ...
        #@nonl
        #@-node:ekr.20081004102201.872:fireNodeAsScript
        #@+node:ekr.20081004102201.873:class _GetReferenceName
        ...
        #@-node:ekr.20081004102201.873:class _GetReferenceName
        #@-node:ekr.20081004102201.866:JythonShell stuff
        #@+node:ekr.20081004102201.874:addUserGuide
        def addUserGuide( self ):
            ...
            help.add( jmi )
        #@-node:ekr.20081004102201.874:addUserGuide
        #@+node:ekr.20081004102201.875:createRecentFilesMenuItems (leoMenu)
        ...
        #@nonl
        #@-node:ekr.20081004102201.875:createRecentFilesMenuItems (leoMenu)
        #@+node:ekr.20081004102201.876:oops
        def oops (self):

            print "leoMenu oops:", g.callerName(2), "should be overridden in subclass"
        #@nonl
        #@-node:ekr.20081004102201.876:oops
        #@+node:ekr.20081004102201.877:Must be overridden in menu subclasses
        #@+node:ekr.20081004102201.878:9 Routines with Tk spellings
        ...
        #@nonl
        #@-node:ekr.20081004102201.878:9 Routines with Tk spellings
        #@+node:ekr.20081004102201.879:7 Routines with new spellings
        ...
        #@-node:ekr.20081004102201.879:7 Routines with new spellings
        #@+node:ekr.20081004102201.880:class MenuRunnable
        ...
        #@nonl
        #@-node:ekr.20081004102201.880:class MenuRunnable
        #@+node:ekr.20081004102201.881:class MenuExecuteOnSelect
        ...
        #@nonl
        #@-node:ekr.20081004102201.881:class MenuExecuteOnSelect
        #@+node:ekr.20081004102201.882:class LeoMenu
...
#@nonl
#@-node:ekr.20081004102201.854:class leoSwingMenu
#@+node:ekr.20081004102201.883:class leoSplash (java.lang.Runnable)
class leoSplash ( java.lang.Runnable ):

    #@    @+others
    #@+node:ekr.20081004102201.884:run (leoSplash)
    def run (self):
        ...
        splash.visible = True
    #@-node:ekr.20081004102201.884:run (leoSplash)
    #@+node:ekr.20081004102201.885:utils
    ...
    #@-others
#@-node:ekr.20081004102201.883:class leoSplash (java.lang.Runnable)
#@+node:ekr.20081004102201.886:class leoSwingLog (REWRITE)
class leoSwingLog (leoFrame.leoLog):

    """A class that represents the log pane of a swing window."""

    #@    @+others
    #@+node:ekr.20081004102201.887:swingLog Birth
    #@+node:ekr.20081004102201.888:swingLog.__init__
    def __init__ (self,frame,parentFrame):
    ...
    #@-node:ekr.20081004102201.888:swingLog.__init__
    #@+node:ekr.20081004102201.889:swingLog.createControl
    def createControl (self,parentFrame):
        ...
        # return self.logCtrl
    #@-node:ekr.20081004102201.889:swingLog.createControl
    #@+node:ekr.20081004102201.890:swingLog.finishCreate
    def finishCreate (self):
        ...
        log.selectTab('Log')
    #@-node:ekr.20081004102201.890:swingLog.finishCreate
    #@+node:ekr.20081004102201.891:swingLog.createTextWidget
    def createTextWidget (self,parentFrame):
        ...
        return log
    #@-node:ekr.20081004102201.891:swingLog.createTextWidget
    #@+node:ekr.20081004102201.892:swingLog.makeTabMenu
    ...
    #@-node:ekr.20081004102201.892:swingLog.makeTabMenu
    #@-node:ekr.20081004102201.887:swingLog Birth
    #@+node:ekr.20081004102201.893:Config & get/saveState
    #@+node:ekr.20081004102201.894:swingLog.configureBorder & configureFont
    ...
    #@-node:ekr.20081004102201.894:swingLog.configureBorder & configureFont
    #@+node:ekr.20081004102201.895:swingLog.getFontConfig
    def getFontConfig (self):
        ...
        return font
    #@-node:ekr.20081004102201.895:swingLog.getFontConfig
    #@+node:ekr.20081004102201.896:swingLog.restoreAllState
    ...
    #@-node:ekr.20081004102201.896:swingLog.restoreAllState
    #@+node:ekr.20081004102201.897:swingLog.saveAllState
    def saveAllState (self):
        ...
        return d
    #@-node:ekr.20081004102201.897:swingLog.saveAllState
    #@+node:ekr.20081004102201.898:swingLog.setColorFromConfig
    def setColorFromConfig (self):
        ...
        try:
            ...
            g.es_exception()
    #@-node:ekr.20081004102201.898:swingLog.setColorFromConfig
    #@+node:ekr.20081004102201.899:swingLog.setFontFromConfig
    ...
    #@-node:ekr.20081004102201.899:swingLog.setFontFromConfig
    #@-node:ekr.20081004102201.893:Config & get/saveState
    #@+node:ekr.20081004102201.900:Focus & update (swingLog)
    #@+node:ekr.20081004102201.901:swingLog.onActivateLog
    ...
    #@-node:ekr.20081004102201.901:swingLog.onActivateLog
    #@+node:ekr.20081004102201.902:swingLog.hasFocus
    def hasFocus (self):

        return self.c.get_focus() == self.logCtrl
    #@-node:ekr.20081004102201.902:swingLog.hasFocus
    #@+node:ekr.20081004102201.903:forceLogUpdate
    ...
    #@-node:ekr.20081004102201.903:forceLogUpdate
    #@-node:ekr.20081004102201.900:Focus & update (swingLog)
    #@+node:ekr.20081004102201.904:put & putnl (swingLog)
    #@+at 
    #@nonl
    ...
    #@-at
    #@+node:ekr.20081004102201.905:put
    ...
    def put (self,s,color=None,tabName='Log'):
        ...
        # if self.logCtrl:
            ...
            #@+node:ekr.20081004102201.906:<< put s to log control >>
            # if color:
                # if color not in self.colorTags:
                    # self.colorTags.append(color)
        ...
        # else:
            ...
            #@+node:ekr.20081004102201.907:<< put s to logWaiting and print s >>
            ...
            #@nl
    #@-node:ekr.20081004102201.905:put
    #@+node:ekr.20081004102201.908:putnl
    ...
    #@-node:ekr.20081004102201.908:putnl
    #@-node:ekr.20081004102201.904:put & putnl (swingLog)
    #@+node:ekr.20081004102201.909:Tab (TkLog)
    #@+node:ekr.20081004102201.910:clearTab
    ...
    #@-node:ekr.20081004102201.910:clearTab
    #@+node:ekr.20081004102201.911:createTab
    def createTab (self,tabName,createText=True,wrap='none'):
        ...
        # if createText:
            ...
            #@+node:ekr.20081004102201.912:<< Create the tab's text widget >>
        ...
        # else:
            ...
            # self.frameDict [tabName] = tabFrame
    #@-node:ekr.20081004102201.911:createTab
    #@+node:ekr.20081004102201.913:cycleTabFocus
    ...
    #@nonl
    #@-node:ekr.20081004102201.913:cycleTabFocus
    #@+node:ekr.20081004102201.914:deleteTab
    ...
    #@-node:ekr.20081004102201.914:deleteTab
    #@+node:ekr.20081004102201.915:hideTab
    def hideTab (self,tabName):
        ...
        self.selectTab('Log')
    #@-node:ekr.20081004102201.915:hideTab
    #@+node:ekr.20081004102201.916:getSelectedTab
    def getSelectedTab (self):

        return self.tabName
    #@-node:ekr.20081004102201.916:getSelectedTab
    #@+node:ekr.20081004102201.917:lower/raiseTab
    ...
    def raiseTab (self,tabName):
        ...
        self.c.bodyWantsFocus()
    #@-node:ekr.20081004102201.917:lower/raiseTab
    #@+node:ekr.20081004102201.918:numberOfVisibleTabs
    def numberOfVisibleTabs (self):

        return len([val for val in self.frameDict.values() if val != None])
    #@-node:ekr.20081004102201.918:numberOfVisibleTabs
    #@+node:ekr.20081004102201.919:renameTab
    def renameTab (self,oldName,newName):
        ...
        pass
    #@-node:ekr.20081004102201.919:renameTab
    #@+node:ekr.20081004102201.920:selectTab
    def selectTab (self,tabName,createText=True,wrap='none'):
        ...
        # return tabFrame
    #@-node:ekr.20081004102201.920:selectTab
    #@+node:ekr.20081004102201.921:setTabBindings
    ...
    #@-node:ekr.20081004102201.921:setTabBindings
    #@+node:ekr.20081004102201.922:Tab menu callbacks & helpers
    #@+node:ekr.20081004102201.923:onRightClick & onClick
    ...
    def onClick (self,event,tabName):
        ...
        self.selectTab(tabName)
    #@-node:ekr.20081004102201.923:onRightClick & onClick
    #@+node:ekr.20081004102201.924:newTabFromMenu
    ...
    #@-node:ekr.20081004102201.924:newTabFromMenu
    #@+node:ekr.20081004102201.925:renameTabFromMenu
    ...
    #@-node:ekr.20081004102201.925:renameTabFromMenu
    #@+node:ekr.20081004102201.926:getTabName
    ...
    #@-node:ekr.20081004102201.922:Tab menu callbacks & helpers
    #@-node:ekr.20081004102201.909:Tab (TkLog)
    #@+node:ekr.20081004102201.927:swingLog color tab stuff
    def createColorPicker (self,tabName):

        log = self

        #@    << define colors >>
        #@+node:ekr.20081004102201.928:<< define colors >>
        colors = (
        ...
        #@+node:ekr.20081004102201.929:<< create optionMenu and callback >>
        ...
        #@+node:ekr.20081004102201.930:<< create picker button and callback >>
        def pickerCallback ():
        ...
        #@nl
    #@-node:ekr.20081004102201.927:swingLog color tab stuff
    #@+node:ekr.20081004102201.931:swingLog font tab stuff
    #@+node:ekr.20081004102201.932:createFontPicker
    def createFontPicker (self,tabName):
        ...
        font = self.getFont()
        #@    << create the frames >>
        #@+node:ekr.20081004102201.933:<< create the frames >>
        ...
        #@+node:ekr.20081004102201.934:<< create the family combo box >>
        ...
        #@+node:ekr.20081004102201.935:<< create the size entry >>
        ...
        #@+node:ekr.20081004102201.936:<< create the weight combo box >>
        ...
        #@+node:ekr.20081004102201.937:<< create the slant combo box>>
        ...
        #@+node:ekr.20081004102201.938:<< create the sample text widget >>
        ...
        #@+node:ekr.20081004102201.939:<< create and bind the callbacks >>
        ...
        self.createBindings()
    #@-node:ekr.20081004102201.932:createFontPicker
    #@+node:ekr.20081004102201.940:createBindings (fontPicker)
    def createBindings (self):
        ...
        k.completeAllBindingsForWidget(w)
    #@-node:ekr.20081004102201.940:createBindings (fontPicker)
    #@+node:ekr.20081004102201.941:getFont
    ...
    #@-node:ekr.20081004102201.941:getFont
    #@+node:ekr.20081004102201.942:setFont
    ...
    #@-node:ekr.20081004102201.942:setFont
    #@+node:ekr.20081004102201.943:hideFontTab
    ...
    #@-others
#@-node:ekr.20081004102201.886:class leoSwingLog (REWRITE)
#@+node:ekr.20081004102201.944:class leoSwingTreeTab (REWRITE)
class leoSwingTreeTab (leoFrame.leoTreeTab):

    '''A class representing a tabbed outline pane drawn with swing.'''

    #@    @+others
    #@+node:ekr.20081004102201.945: Birth & death
    #@+node:ekr.20081004102201.946: ctor (leoTreeTab)
    def __init__ (self,c,parentFrame,chapterController):
        ...
        self.createControl()
    #@-node:ekr.20081004102201.946: ctor (leoTreeTab)
    #@+node:ekr.20081004102201.947:tt.createControl
    ...
    #@-node:ekr.20081004102201.947:tt.createControl
    #@-node:ekr.20081004102201.945: Birth & death
    #@+node:ekr.20081004102201.948:Tabs...
    #@+node:ekr.20081004102201.949:tt.createTab
    def createTab (self,tabName,select=True):
        ...
        if tabName not in tt.tabNames:
            ...
            tt.setNames()
    #@-node:ekr.20081004102201.949:tt.createTab
    #@+node:ekr.20081004102201.950:tt.destroyTab
    def destroyTab (self,tabName):
        ...
        if tabName in tt.tabNames:
            ...
            tt.setNames()
    #@-node:ekr.20081004102201.950:tt.destroyTab
    #@+node:ekr.20081004102201.951:tt.selectTab
    ...
    #@-node:ekr.20081004102201.951:tt.selectTab
    #@+node:ekr.20081004102201.952:tt.setTabLabel
    def setTabLabel (self,tabName):

        tt = self
        tt.chapterVar.set(tabName)
    #@-node:ekr.20081004102201.952:tt.setTabLabel
    #@+node:ekr.20081004102201.953:tt.setNames
    def setNames (self):
...
#@nonl
#@-node:ekr.20081004102201.944:class leoSwingTreeTab (REWRITE)
#@+node:ekr.20081004102201.954:class leoSwingTextWidget (revise)
class leoSwingTextWidget: ### (leoFrame.baseTextWidget):
    ...
    #@    @+others
    #@+node:ekr.20081004102201.955:swingTextWidget.__init__
    ...
    #@-node:ekr.20081004102201.955:swingTextWidget.__init__
    #@+node:ekr.20081004102201.956:bindings (not used)
    ...
    #@-node:ekr.20081004102201.956:bindings (not used)
    #@+node:ekr.20081004102201.957:Index conversion (swingTextWidget)
    #@+node:ekr.20081004102201.958:w.toGuiIndex
    ...
    #@nonl
    #@-node:ekr.20081004102201.958:w.toGuiIndex
    #@+node:ekr.20081004102201.959:w.toPythonIndex
    def toPythonIndex (self,i):
        ...
        return i
    #@-node:ekr.20081004102201.959:w.toPythonIndex
    #@+node:ekr.20081004102201.960:w.rowColToGuiIndex
    ...
    #@-node:ekr.20081004102201.960:w.rowColToGuiIndex
    #@-node:ekr.20081004102201.957:Index conversion (swingTextWidget)
    #@+node:ekr.20081004102201.961:getName (Tk.Text)
    def getName (self):
    ...
    #@nonl
    #@-node:ekr.20081004102201.961:getName (Tk.Text)
    #@+node:ekr.20081004102201.962:_setSelectionRange
    if 0:
    ...
    #@-node:ekr.20081004102201.962:_setSelectionRange
    #@+node:ekr.20081004102201.963:Wrapper methods (swingTextWidget)
    #@+node:ekr.20081004102201.964:after_idle (new)
    def after_idle(self,*args,**keys):

        pass
    #@-node:ekr.20081004102201.964:after_idle (new)
    #@+node:ekr.20081004102201.965:bind (new)
    def bind (self,*args,**keys):

        pass
    #@-node:ekr.20081004102201.965:bind (new)
    #@+node:ekr.20081004102201.966:delete
    ...
    #@-node:ekr.20081004102201.966:delete
    #@+node:ekr.20081004102201.967:flashCharacter
    ...
    #@nonl
    #@-node:ekr.20081004102201.967:flashCharacter
    #@+node:ekr.20081004102201.968:get
    ...
    #@-node:ekr.20081004102201.968:get
    #@+node:ekr.20081004102201.969:getAllText
    ...
    #@-node:ekr.20081004102201.969:getAllText
    #@+node:ekr.20081004102201.970:getInsertPoint
    def getInsertPoint(self): # swingTextWidget.
        ...
        return i
    #@-node:ekr.20081004102201.970:getInsertPoint
    #@+node:ekr.20081004102201.971:getSelectedText
    def getSelectedText (self): # swingTextWidget.
        ...
        if i != j:
            ...
            return u""
    #@-node:ekr.20081004102201.971:getSelectedText
    #@+node:ekr.20081004102201.972:getSelectionRange
    ...
    #@nonl
    #@-node:ekr.20081004102201.972:getSelectionRange
    #@+node:ekr.20081004102201.973:getYScrollPosition
    def getYScrollPosition (self):

         w = self
         return 0 ### return w.yview()
    #@-node:ekr.20081004102201.973:getYScrollPosition
    #@+node:ekr.20081004102201.974:getWidth
    def getWidth (self):
    ...
    #@-node:ekr.20081004102201.974:getWidth
    #@+node:ekr.20081004102201.975:hasSelection
    def hasSelection (self):
        ...
        return i != j
    #@-node:ekr.20081004102201.975:hasSelection
    #@+node:ekr.20081004102201.976:insert
    ...
    #@-node:ekr.20081004102201.976:insert
    #@+node:ekr.20081004102201.977:indexIsVisible
    ...
    #@nonl
    #@-node:ekr.20081004102201.977:indexIsVisible
    #@+node:ekr.20081004102201.978:mark_set NO LONGER USED
    ...
    #@-node:ekr.20081004102201.978:mark_set NO LONGER USED
    #@+node:ekr.20081004102201.979:replace
    def replace (self,i,j,s): # swingTextWidget
        ...
        ### Tk.Text.insert(w,i,s)
    #@-node:ekr.20081004102201.979:replace
    #@+node:ekr.20081004102201.980:see
    def see (self,i): # swingTextWidget.
        ...
        ### Tk.Text.see(w,i)
    #@-node:ekr.20081004102201.980:see
    #@+node:ekr.20081004102201.981:seeInsertPoint
    def seeInsertPoint (self): # swingTextWidget.

        w = self
        ### Tk.Text.see(w,'insert')
    #@-node:ekr.20081004102201.981:seeInsertPoint
    #@+node:ekr.20081004102201.982:selectAllText
    ...
    #@-node:ekr.20081004102201.982:selectAllText
    #@+node:ekr.20081004102201.983:setAllText
    ...
    #@-node:ekr.20081004102201.983:setAllText
    #@+node:ekr.20081004102201.984:setBackgroundColor
    ...
    #@nonl
    #@-node:ekr.20081004102201.984:setBackgroundColor
    #@+node:ekr.20081004102201.985:setInsertPoint
    ...
    #@-node:ekr.20081004102201.985:setInsertPoint
    #@+node:ekr.20081004102201.986:setSelectionRange
    def setSelectionRange (self,i,j,insert=None): # swingTextWidget
        ...
        # if insert is not None:
            # w.setInsertPoint(insert)
    #@-node:ekr.20081004102201.986:setSelectionRange
    #@+node:ekr.20081004102201.987:setYScrollPosition
    ...
    #@nonl
    #@-node:ekr.20081004102201.987:setYScrollPosition
    #@+node:ekr.20081004102201.988:setWidth
    ...
    #@-node:ekr.20081004102201.988:setWidth
    #@+node:ekr.20081004102201.989:tag_add
    ...
    #@-node:ekr.20081004102201.989:tag_add
    #@+node:ekr.20081004102201.990:tag_configure (NEW)
    ...
    #@-node:ekr.20081004102201.990:tag_configure (NEW)
    #@+node:ekr.20081004102201.991:tag_ranges
    def tag_ranges(self,tagName):
        ...
        return tuple(aList)
    #@-node:ekr.20081004102201.991:tag_ranges
    #@+node:ekr.20081004102201.992:tag_remove
    ...
    #@-node:ekr.20081004102201.992:tag_remove
    #@+node:ekr.20081004102201.993:w.deleteTextSelection
    ...
    #@-node:ekr.20081004102201.993:w.deleteTextSelection
    #@+node:ekr.20081004102201.994:xyToGui/PythonIndex
...
#@nonl
#@-node:ekr.20081004102201.954:class leoSwingTextWidget (revise)
#@+node:ekr.20081004102201.995:class leoSwingTree (REWRITE)
class leoSwingTree (leoFrame.leoTree):
    ...
    #@    @+others
    #@+node:ekr.20081004102201.996:  Notes
    #@@killcolor
    #@+node:ekr.20081004102201.997:Changes made since first update
    #@+at
    # 
    ...
    #@-at
    #@-node:ekr.20081004102201.997:Changes made since first update
    #@+node:ekr.20081004102201.998:Changes made since second update
    #@+at
    # 
    ...
    #@-at
    #@-node:ekr.20081004102201.998:Changes made since second update
    #@+node:ekr.20081004102201.999:Most recent changes
    #@+at
    # 
    ...
    #@-node:ekr.20081004102201.999:Most recent changes
    #@-node:ekr.20081004102201.996:  Notes
    #@+node:ekr.20081004102201.1000: Birth... (swingTree)
    #@+node:ekr.20081004102201.1001:__init__ (swingTree)
    def __init__(self,c,frame,canvas):
        ...
        #@+node:ekr.20081004102201.1002:<< define drawing constants >>
        ...
        #@nl
        #@    << old ivars >>
        #@+node:ekr.20081004102201.1003:<< old ivars >>
        # Miscellaneous info.
        ...
        #@+node:ekr.20081004102201.1004:<< inject callbacks into the position class >>
        ...
        self.freeUserIcons = []
    #@-node:ekr.20081004102201.1001:__init__ (swingTree)
    #@+node:ekr.20081004102201.1005:swingTtree.setBindings
    def setBindings (self,):
        ...
        if 0:
            ...
            #@+node:ekr.20081004102201.1006:<< make bindings for a common binding widget >>
    ...
    #@-node:ekr.20081004102201.1005:swingTtree.setBindings
    #@+node:ekr.20081004102201.1007:swingTree.setCanvasBindings
    def setCanvasBindings (self,canvas):
        ...
        if 0: ###
            ...
            #@+node:ekr.20081004102201.1008:<< make bindings for tagged items on the canvas >>
            ...
            #@+node:ekr.20081004102201.1009:<< create baloon bindings for tagged items on the canvas >>
    ...
    #@-node:ekr.20081004102201.1007:swingTree.setCanvasBindings
    #@-node:ekr.20081004102201.1000: Birth... (swingTree)
    #@+node:ekr.20081004102201.1010:Allocation...
    #@+node:ekr.20081004102201.1011:newBox
    def newBox (self,p,x,y,image):
        ...
        return theId
    #@-node:ekr.20081004102201.1011:newBox
    #@+node:ekr.20081004102201.1012:newClickBox
    def newClickBox (self,p,x1,y1,x2,y2):
        ...
        return theId
    #@-node:ekr.20081004102201.1012:newClickBox
    #@+node:ekr.20081004102201.1013:newIcon
    def newIcon (self,p,x,y,image):
        ...
        return theId
    #@-node:ekr.20081004102201.1013:newIcon
    #@+node:ekr.20081004102201.1014:newLine
    def newLine (self,p,x1,y1,x2,y2):
        ...
        return theId
    #@-node:ekr.20081004102201.1014:newLine
    #@+node:ekr.20081004102201.1015:newText (swingTree) and helper
    def newText (self,p,x,y):
        ...
        if self.freeText:
            ...
            if 0: # Crashes on XP.
                ...
                #@+node:ekr.20081004102201.1016:<< patch by Maciej Kalisiak  to handle scroll-wheel events >>
        ...
        return w
    #@+node:ekr.20081004102201.1017:tree.setHeadlineText
    ...
    #@-node:ekr.20081004102201.1017:tree.setHeadlineText
    #@-node:ekr.20081004102201.1015:newText (swingTree) and helper
    #@+node:ekr.20081004102201.1018:recycleWidgets
    def recycleWidgets (self):
        ...
        self.visibleUserIcons = []
    #@-node:ekr.20081004102201.1018:recycleWidgets
    #@+node:ekr.20081004102201.1019:destroyWidgets
    ...
    #@-node:ekr.20081004102201.1019:destroyWidgets
    #@+node:ekr.20081004102201.1020:showStats
    def showStats (self):
    ...
    #@-node:ekr.20081004102201.1020:showStats
    #@-node:ekr.20081004102201.1010:Allocation...
    #@+node:ekr.20081004102201.1021:Config & Measuring...
    #@+node:ekr.20081004102201.1022:tree.getFont,setFont,setFontFromConfig
    def getFont (self):
    ...
    def setFontFromConfig (self):
        ...
        self.setFont(font)
    #@-node:ekr.20081004102201.1022:tree.getFont,setFont,setFontFromConfig
    #@+node:ekr.20081004102201.1023:headWidth & widthInPixels
    ...
    #@-node:ekr.20081004102201.1023:headWidth & widthInPixels
    #@+node:ekr.20081004102201.1024:setLineHeight
    ...
    #@-node:ekr.20081004102201.1024:setLineHeight
    #@-node:ekr.20081004102201.1021:Config & Measuring...
    #@+node:ekr.20081004102201.1025:Debugging...
    #@+node:ekr.20081004102201.1026:textAddr
    def textAddr(self,w):
    ...
    #@-node:ekr.20081004102201.1026:textAddr
    #@+node:ekr.20081004102201.1027:traceIds (Not used)
    ...
    #@-node:ekr.20081004102201.1027:traceIds (Not used)
    #@-node:ekr.20081004102201.1025:Debugging...
    #@+node:ekr.20081004102201.1028:Drawing... (swingTree)
    #@+node:ekr.20081004102201.1029:tree.begin/endUpdate
    ...
    #@-node:ekr.20081004102201.1029:tree.begin/endUpdate
    #@+node:ekr.20081004102201.1030:tree.redraw_now & helper
    ...
    #@+node:ekr.20081004102201.1031:redrawHelper
    ...
    #@-node:ekr.20081004102201.1031:redrawHelper
    #@-node:ekr.20081004102201.1030:tree.redraw_now & helper
    #@+node:ekr.20081004102201.1032:idle_second_redraw
    ...
    #@-node:ekr.20081004102201.1032:idle_second_redraw
    #@+node:ekr.20081004102201.1033:drawX...
    #@+node:ekr.20081004102201.1034:drawBox
    def drawBox (self,p,x,y):
        ...
        if theId is None:
            ...
            return theId
    #@-node:ekr.20081004102201.1034:drawBox
    #@+node:ekr.20081004102201.1035:drawClickBox
    ...
    #@-node:ekr.20081004102201.1035:drawClickBox
    #@+node:ekr.20081004102201.1036:drawIcon
    def drawIcon(self,p,x=None,y=None):
        ...
        #@+node:ekr.20081004102201.1037:<< compute x,y and iconVal >>
    ...
    #@-node:ekr.20081004102201.1036:drawIcon
    #@+node:ekr.20081004102201.1038:drawLine
    def drawLine (self,p,x1,y1,x2,y2):
        ...
        return theId
    #@-node:ekr.20081004102201.1038:drawLine
    #@+node:ekr.20081004102201.1039:drawNode & force_draw_node (good trace)
    ...
    #@+node:ekr.20081004102201.1040:force_draw_node
    ...
    #@-node:ekr.20081004102201.1040:force_draw_node
    #@-node:ekr.20081004102201.1039:drawNode & force_draw_node (good trace)
    #@+node:ekr.20081004102201.1041:drawText
    ...
    #@-node:ekr.20081004102201.1041:drawText
    #@+node:ekr.20081004102201.1042:drawUserIcons
    def drawUserIcons(self,p,where,x,y):
        ...
        return h,w
    #@-node:ekr.20081004102201.1042:drawUserIcons
    #@+node:ekr.20081004102201.1043:drawUserIcon
    def drawUserIcon (self,p,where,x,y,w2,theDict):
        ...
        #@+node:ekr.20081004102201.1044:<< set offsets and pads >>
        ...
        if theType == "icon":
            if 0: # not ready yet.
                ...
                #@+node:ekr.20081004102201.1045:<< draw the icon in string s >>
                pass
                #@-node:ekr.20081004102201.1045:<< draw the icon in string s >>
                #@nl
        elif theType == "file":
            ...
            #@+node:ekr.20081004102201.1046:<< draw the icon at file >>
            try:
            ...
            #@+node:ekr.20081004102201.1047:<< draw the icon at url >>
            pass
            #@-node:ekr.20081004102201.1047:<< draw the icon at url >>
            #@nl
        ...
        return h,w
    #@-node:ekr.20081004102201.1043:drawUserIcon
    #@+node:ekr.20081004102201.1048:drawTopTree
    ...
    #@-node:ekr.20081004102201.1048:drawTopTree
    #@+node:ekr.20081004102201.1049:drawTree
    ...
    #@-node:ekr.20081004102201.1049:drawTree
    #@-node:ekr.20081004102201.1033:drawX...
    #@+node:ekr.20081004102201.1050:Helpers...
    #@+node:ekr.20081004102201.1051:getIconImage
    def getIconImage (self, name):
        ...
        try:
            ...
            return None
    #@-node:ekr.20081004102201.1051:getIconImage
    #@+node:ekr.20081004102201.1052:inVisibleArea & inExpandedVisibleArea
    ...
    def inExpandedVisibleArea (self,y1):
        ...
        if self.expandedVisibleArea:
            ...
            return False
    #@-node:ekr.20081004102201.1052:inVisibleArea & inExpandedVisibleArea
    #@+node:ekr.20081004102201.1053:numberOfVisibleNodes
    def numberOfVisibleNodes(self):
        ...
        return n
    #@-node:ekr.20081004102201.1053:numberOfVisibleNodes
    #@+node:ekr.20081004102201.1054:scrollTo (swingTree)
    def scrollTo(self,p=None):
        ...
        try:
            ...
            if self.center_selected_tree_node: # New in Leo 4.4.3.
                #@            << compute frac0 >>
                #@+node:ekr.20081004102201.1055:<< compute frac0 >>
                ...
                #@+node:ekr.20081004102201.1056:<< compute approximate line height >>
                ...
                #@+node:ekr.20081004102201.1057:<< Compute the fractions to scroll down/up >>
    ...
    #@nonl
    #@-node:ekr.20081004102201.1054:scrollTo (swingTree)
    #@+node:ekr.20081004102201.1058:yoffset (swingTree)
    #@+at 
    #@nonl
    ...
    #@-node:ekr.20081004102201.1050:Helpers...
    #@-node:ekr.20081004102201.1028:Drawing... (swingTree)
    #@+node:ekr.20081004102201.1059:Event handlers (swingTree)
    #@+node:ekr.20081004102201.1060:Helpers
    #@+node:ekr.20081004102201.1061:checkWidgetList
    def checkWidgetList (self,tag):
        ...
        return True
    #@-node:ekr.20081004102201.1061:checkWidgetList
    #@+node:ekr.20081004102201.1062:dumpWidgetList
    ...
    #@-node:ekr.20081004102201.1062:dumpWidgetList
    #@+node:ekr.20081004102201.1063:tree.edit_widget
    ...
    #@nonl
    #@-node:ekr.20081004102201.1063:tree.edit_widget
    #@+node:ekr.20081004102201.1064:eventToPosition
    ...
    #@-node:ekr.20081004102201.1064:eventToPosition
    #@+node:ekr.20081004102201.1065:findEditWidget
    def findEditWidget (self,p):
        ...
        return None
    #@-node:ekr.20081004102201.1065:findEditWidget
    #@+node:ekr.20081004102201.1066:findVnodeWithIconId
    ...
    #@-node:ekr.20081004102201.1066:findVnodeWithIconId
    #@-node:ekr.20081004102201.1060:Helpers
    #@+node:ekr.20081004102201.1067:Click Box...
    #@+node:ekr.20081004102201.1068:onClickBoxClick
    ...
    #@-node:ekr.20081004102201.1068:onClickBoxClick
    #@-node:ekr.20081004102201.1067:Click Box...
    #@+node:ekr.20081004102201.1069:Dragging (swingTree)
    #@+node:ekr.20081004102201.1070:endDrag
    def endDrag (self,event):
        ...
        try:
            #@        << set vdrag, childFlag >>
            #@+node:ekr.20081004102201.1071:<< set vdrag, childFlag >>
            x,y = event.x,event.y
            ...
            if redrawFlag: # Disallow drag to joined node.
                #@            << drag p to vdrag >>
                #@+node:ekr.20081004102201.1072:<< drag p to vdrag >>
    ...
    #@-node:ekr.20081004102201.1070:endDrag
    #@+node:ekr.20081004102201.1073:startDrag
    ...
    #@-node:ekr.20081004102201.1073:startDrag
    #@+node:ekr.20081004102201.1074:onContinueDrag
    def onContinueDrag(self,event):
        ...
        try:
            ...
            if self.dragging: # This gets cleared by onEndDrag()
                ...
                #@+node:ekr.20081004102201.1075:<< scroll the canvas as needed >>
    ...
    #@-node:ekr.20081004102201.1074:onContinueDrag
    #@+node:ekr.20081004102201.1076:onDrag
    ...
    #@-node:ekr.20081004102201.1076:onDrag
    #@+node:ekr.20081004102201.1077:onEndDrag
    ...
    #@-node:ekr.20081004102201.1077:onEndDrag
    #@-node:ekr.20081004102201.1069:Dragging (swingTree)
    #@+node:ekr.20081004102201.1078:Icon Box...
    #@+node:ekr.20081004102201.1079:onIconBoxClick
    ...
    #@-node:ekr.20081004102201.1079:onIconBoxClick
    #@+node:ekr.20081004102201.1080:onIconBoxRightClick
    def onIconBoxRightClick (self,event,p=None):
        ...
        return 'break'
    #@-node:ekr.20081004102201.1080:onIconBoxRightClick
    #@+node:ekr.20081004102201.1081:onIconBoxDoubleClick
    ...
    #@-node:ekr.20081004102201.1081:onIconBoxDoubleClick
    #@-node:ekr.20081004102201.1078:Icon Box...
    #@+node:ekr.20081004102201.1082:OnActivateHeadline (swingTree)
    def OnActivateHeadline (self,p,event=None):
        ...
        try:
            ...
            #@+node:ekr.20081004102201.1083:<< activate this window >>
        ...
        return returnVal
    #@-node:ekr.20081004102201.1082:OnActivateHeadline (swingTree)
    #@+node:ekr.20081004102201.1084:Text Box...
    #@+node:ekr.20081004102201.1085:configureTextState
    ...
    #@-node:ekr.20081004102201.1085:configureTextState
    #@+node:ekr.20081004102201.1086:onCtontrolT
    ...
    def onControlT (self,event=None):
        ...
        return "break"
    #@-node:ekr.20081004102201.1086:onCtontrolT
    #@+node:ekr.20081004102201.1087:onHeadlineClick
    def onHeadlineClick (self,event,p=None):
        ...
        return returnVal
    #@-node:ekr.20081004102201.1087:onHeadlineClick
    #@+node:ekr.20081004102201.1088:onHeadlineRightClick
    ...
    #@-node:ekr.20081004102201.1088:onHeadlineRightClick
    #@-node:ekr.20081004102201.1084:Text Box...
    #@+node:ekr.20081004102201.1089:tree.OnDeactivate
    def OnDeactivate (self,event=None):
        ...
        try:
            ...
            c.endUpdate(False)
    #@-node:ekr.20081004102201.1089:tree.OnDeactivate
    #@+node:ekr.20081004102201.1090:tree.OnPopup & allies
    def OnPopup (self,p,event):
        ...
        return "break"
    #@+node:ekr.20081004102201.1091:OnPopupFocusLost
    #@+at 
    #@nonl
    ...
    #@-node:ekr.20081004102201.1091:OnPopupFocusLost
    #@+node:ekr.20081004102201.1092:createPopupMenu
    def createPopupMenu (self,event):
        ...
        #@+node:ekr.20081004102201.1093:<< Create the menu table >>
        table = (
        ...
        frame.menu.createMenuEntries(menu,table)
    #@-node:ekr.20081004102201.1092:createPopupMenu
    #@+node:ekr.20081004102201.1094:enablePopupMenuItems
    def enablePopupMenuItems (self,v,event):
        ...
        #@+node:ekr.20081004102201.1095:<< set isAtRoot and isAtFile if v's tree contains @root or @file nodes >>
        isAtFile = False
        isAtRoot = False
    ...
    #@-node:ekr.20081004102201.1094:enablePopupMenuItems
    #@+node:ekr.20081004102201.1096:showPopupMenu
    ...
    #@-node:ekr.20081004102201.1096:showPopupMenu
    #@-node:ekr.20081004102201.1090:tree.OnPopup & allies
    #@+node:ekr.20081004102201.1097:onTreeClick
    ...
    #@-node:ekr.20081004102201.1097:onTreeClick
    #@-node:ekr.20081004102201.1059:Event handlers (swingTree)
    #@+node:ekr.20081004102201.1098:Incremental drawing...
    #@+node:ekr.20081004102201.1099:allocateNodes
    ...
    #@-node:ekr.20081004102201.1099:allocateNodes
    #@+node:ekr.20081004102201.1100:allocateNodesBeforeScrolling
    def allocateNodesBeforeScrolling (self, args):
        ...
        if len(args) == 2:
            ...
            self.allocateNodes(where=where,lines=lines)
    #@-node:ekr.20081004102201.1100:allocateNodesBeforeScrolling
    #@+node:ekr.20081004102201.1101:updateNode
    def updateNode (self,p,x,y):
        ...
        return self.line_height
    #@-node:ekr.20081004102201.1101:updateNode
    #@+node:ekr.20081004102201.1102:setVisibleAreaToFullCanvas
    ...
    #@-node:ekr.20081004102201.1102:setVisibleAreaToFullCanvas
    #@+node:ekr.20081004102201.1103:setVisibleArea
    ...
    #@-node:ekr.20081004102201.1103:setVisibleArea
    #@+node:ekr.20081004102201.1104:tree.updateTree
    ...
    #@-node:ekr.20081004102201.1104:tree.updateTree
    #@-node:ekr.20081004102201.1098:Incremental drawing...
    #@+node:ekr.20081004102201.1105:Selecting & editing... (swingTree)
    #@+node:ekr.20081004102201.1106:dimEditLabel, undimEditLabel
    ...
    def undimEditLabel (self):
        ...
        self.setSelectedLabelState(p)
    #@-node:ekr.20081004102201.1106:dimEditLabel, undimEditLabel
    #@+node:ekr.20081004102201.1107:tree.editLabel
    ...
    #@-node:ekr.20081004102201.1107:tree.editLabel
    #@+node:ekr.20081004102201.1108:tree.set...LabelState
    #@+node:ekr.20081004102201.1109:setEditLabelState
    ...
    #@-node:ekr.20081004102201.1109:setEditLabelState
    #@+node:ekr.20081004102201.1110:setSelectedLabelState
    ...
    #@-node:ekr.20081004102201.1110:setSelectedLabelState
    #@+node:ekr.20081004102201.1111:setUnselectedLabelState
    ...
    #@-node:ekr.20081004102201.1111:setUnselectedLabelState
    #@+node:ekr.20081004102201.1112:setDisabledHeadlineColors
    def setDisabledHeadlineColors (self,p):
        ...
        try:
            ...
            g.es_exception()
    #@-node:ekr.20081004102201.1112:setDisabledHeadlineColors
    #@+node:ekr.20081004102201.1113:setEditHeadlineColors
    def setEditHeadlineColors (self,p):
        ...
        try: # Use system defaults for selection foreground/background
            ...
            g.es_exception()
    #@-node:ekr.20081004102201.1113:setEditHeadlineColors
    #@+node:ekr.20081004102201.1114:setUnselectedHeadlineColors
    ...
    #@-node:ekr.20081004102201.1114:setUnselectedHeadlineColors
    #@-node:ekr.20081004102201.1108:tree.set...LabelState
    #@+node:ekr.20081004102201.1115:tree.setHeadline (swingTree)
...
#@-node:ekr.20081004102201.995:class leoSwingTree (REWRITE)
#@-node:ekr.20081004102201.734:leoSwingFrame
#@+node:ekr.20081004102201.1117:leoSwingGui
class swingGui(leoGui.leoGui):

    """A class encapulating all calls to swing."""

    #@    @+others
    #@+node:ekr.20081004102201.1118:swingGui birth & death
    #@+node:ekr.20081004102201.1119: swingGui.__init__
    def __init__ (self):
    ...
    #@nonl
    #@-node:ekr.20081004102201.1119: swingGui.__init__
    #@+node:ekr.20081004102201.1120:createKeyHandlerClass (swingGui)
    ...
    #@-node:ekr.20081004102201.1120:createKeyHandlerClass (swingGui)
    #@+node:ekr.20081004102201.1121:runMainLoop (swingGui)
    ...
    #@-node:ekr.20081004102201.1121:runMainLoop (swingGui)
    #@+node:ekr.20081004102201.1122:Not used
    ...
    if 0:
        #@    @+others
        #@+node:ekr.20081004102201.1123:swingGui.setDefaultIcon
        def setDefaultIcon(self):
            ...
            try:
                ...
                import traceback ; traceback.print_exc()
        #@-node:ekr.20081004102201.1123:swingGui.setDefaultIcon
        #@+node:ekr.20081004102201.1124:swingGui.getDefaultConfigFont
    ...
    #@-node:ekr.20081004102201.1122:Not used
    #@-node:ekr.20081004102201.1118:swingGui birth & death
    #@+node:ekr.20081004102201.1125:swingGui dialogs & panels
    ...
    #@+node:ekr.20081004102201.1126:swingGui.createSpellTab
    def createSpellTab(self,c,spellHandler,tabName):
        ...
        pass
    #@-node:ekr.20081004102201.1126:swingGui.createSpellTab
    #@+node:ekr.20081004102201.1127:swingGui file dialogs
    # We no longer specify default extensions so that we can open and save files without extensions.
    #@+node:ekr.20081004102201.1128:runOpenFileDialog
    def runOpenFileDialog(self,title,filetypes,defaultextension,multiple=False):
        ...
        if multiple:
            ...
            return swingFileDialog.askopenfilename(
                title=title,filetypes=filetypes,initialdir=initialdir)
    #@-node:ekr.20081004102201.1128:runOpenFileDialog
    #@+node:ekr.20081004102201.1129:runSaveFileDialog
    ...
    #@-node:ekr.20081004102201.1129:runSaveFileDialog
    #@-node:ekr.20081004102201.1127:swingGui file dialogs
    #@+node:ekr.20081004102201.1130:swingGui panels
    ...
    #@-node:ekr.20081004102201.1130:swingGui panels
    #@-node:ekr.20081004102201.1125:swingGui dialogs & panels
    #@+node:ekr.20081004102201.1131:swingGui utils (TO DO)
    #@+node:ekr.20081004102201.1132:Clipboard (swingGui)
    #@+node:ekr.20081004102201.1133:replaceClipboardWith
    ...
    #@-node:ekr.20081004102201.1133:replaceClipboardWith
    #@+node:ekr.20081004102201.1134:getTextFromClipboard
    ...
    #@-node:ekr.20081004102201.1134:getTextFromClipboard
    #@-node:ekr.20081004102201.1132:Clipboard (swingGui)
    #@+node:ekr.20081004102201.1135:color
    ...
    #@-node:ekr.20081004102201.1135:color
    #@+node:ekr.20081004102201.1136:Dialog
    #@+node:ekr.20081004102201.1137:get_window_info
    ...
    def get_window_info (self,top):
        ...
        return w,h,x,y
    #@-node:ekr.20081004102201.1137:get_window_info
    #@+node:ekr.20081004102201.1138:center_dialog
    def center_dialog(self,top):
        ...
        return w,h,x,y
    #@-node:ekr.20081004102201.1138:center_dialog
    #@+node:ekr.20081004102201.1139:create_labeled_frame
    ...
    #@-node:ekr.20081004102201.1139:create_labeled_frame
    #@-node:ekr.20081004102201.1136:Dialog
    #@+node:ekr.20081004102201.1140:Events (swingGui)
    ...
    #@nonl
    #@-node:ekr.20081004102201.1140:Events (swingGui)
    #@+node:ekr.20081004102201.1141:Focus
    #@+node:ekr.20081004102201.1142:swingGui.get_focus
    ...
    #@-node:ekr.20081004102201.1142:swingGui.get_focus
    #@+node:ekr.20081004102201.1143:swing.Gui.set_focus
    set_focus_count = 0
    ...
    #@-node:ekr.20081004102201.1143:swing.Gui.set_focus
    #@-node:ekr.20081004102201.1141:Focus
    #@+node:ekr.20081004102201.1144:Font
    #@+node:ekr.20081004102201.1145:swingGui.getFontFromParams
    ...
    #@-node:ekr.20081004102201.1145:swingGui.getFontFromParams
    #@-node:ekr.20081004102201.1144:Font
    #@+node:ekr.20081004102201.1146:getFullVersion
    ...
    #@-node:ekr.20081004102201.1146:getFullVersion
    #@+node:ekr.20081004102201.1147:Icons
    #@+node:ekr.20081004102201.1148:attachLeoIcon & createLeoIcon
    def attachLeoIcon (self,w):
        ...
        if self.bitmap == None:
            try:
                ...
                #@+node:ekr.20081004102201.1149:<< try to use the PIL and tkIcon packages to draw the icon >>
                #@+at 
                #@nonl
                ...
                # g.es_exception()
                self.leoIcon = None
    #@+node:ekr.20081004102201.1150:createLeoIcon
    ...
    #@-node:ekr.20081004102201.1148:attachLeoIcon & createLeoIcon
    #@-node:ekr.20081004102201.1147:Icons
    #@+node:ekr.20081004102201.1151:Idle Time
    #@+node:ekr.20081004102201.1152:swingGui.setIdleTimeHook
    ...
    #@nonl
    #@-node:ekr.20081004102201.1152:swingGui.setIdleTimeHook
    #@+node:ekr.20081004102201.1153:setIdleTimeHookAfterDelay
    ...
    #@-node:ekr.20081004102201.1153:setIdleTimeHookAfterDelay
    #@-node:ekr.20081004102201.1151:Idle Time
    #@+node:ekr.20081004102201.1154:isTextWidget
    ...
    #@-node:ekr.20081004102201.1154:isTextWidget
    #@+node:ekr.20081004102201.1155:makeScriptButton
    def makeScriptButton (self,c,
        ...
        #@    << create the button b >>
        #@+node:ekr.20081004102201.1156:<< create the button b >>
        ...
        #@+node:ekr.20081004102201.1157:<< define the callbacks for b >>
        ...
        if shortcut:
            ...
            #@+node:ekr.20081004102201.1158:<< bind the shortcut to executeScriptCallback >>
        ...
        #@+node:ekr.20081004102201.1159:<< create press-buttonText-button command >>
    ...
    #@-node:ekr.20081004102201.1155:makeScriptButton
    #@-node:ekr.20081004102201.1131:swingGui utils (TO DO)
    #@+node:ekr.20081004102201.1160:class leoKeyEvent (swingGui)
    class leoKeyEvent:
