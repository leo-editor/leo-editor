...
class IdleTime:
    ...
    #@+others
    #@+node:ekr.20140825042850.18406: ** IdleTime.__init__
    ...
    #@+node:ekr.20140825102404.18525: ** IdleTime.__repr__
    def __repr__(self):
        '''IdleTime repr.'''
        tag = self.tag
        if tag:
    ...
    __str__ = __repr__
    #@+node:ekr.20140825042850.18407: ** IdleTime.at_idle_time
    def at_idle_time(self):
        ...
        if g.app.killed:
            ...
            self.timer.stop()
    #@+node:ekr.20140825042850.18408: ** IdleTime.call_handler
    def call_handler(self):
        ...
        try:
            ...
            g.es_exception()
            self.stop()
    #@+node:ekr.20140825080012.18529: ** IdleTime.destory_self
    ...
    #@+node:ekr.20140825042850.18409: ** IdleTime.start & stop
    def start(self):
