...
class Importer:
    ...
    #@+node:ekr.20220727085532.1: *6* i.body_lines & body_string
    ...
    #@+node:ekr.20220727085911.1: *6* i.declaration_headline
    ...
    gen_lines = new_gen_lines if NEW_GEN_LINES else old_gen_lines
