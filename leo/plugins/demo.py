...
#@+<< demo docstring >>
#@+node:ekr.20170128213103.2: ** << demo docstring >>
#@@language rest
...
This plugin is based on [demo-it](https://github.com/howardabrams/demo-it/blob/master/demo-it.org)

To run a demo, instantiate a Demo class and call Demo.demo.

is a tool for people wanting to demonstrate Leo or some Leonine
