...
def init():
    ...
    if g.app.gui:
        ...
        return True
#@+node:ekr.20140907103315.18782: ** gui commands
#@+node:tbrown.20140620095406.40066: *3* gui-show/hide/toggle commands
...
#@+node:tbrown.20140814090009.55874: *3* style_reload command
